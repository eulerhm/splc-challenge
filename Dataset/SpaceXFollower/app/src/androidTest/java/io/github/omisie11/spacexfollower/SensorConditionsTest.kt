    ...
    companion object {
        ...
        fun setUpSensorConditions() {
           ...
           if (doNotDisturbEnabled) {
            ...
            enableDisableSensor(mDevice, "Camera Light Sensor", lightEnabled) //For Galaxy M30!
                    ...
                    if (!inspectSensorOption && obj.isClickable) {
                        ...
                        if (UIObjectSensorDisablerOptions.exists()) {
                            ...
                            UIObjectSaveOptions = mDevice.findObject(
                                UiSelector().className("android.widget.ImageButton").instance(1) //For Galaxy M30!
                            )
