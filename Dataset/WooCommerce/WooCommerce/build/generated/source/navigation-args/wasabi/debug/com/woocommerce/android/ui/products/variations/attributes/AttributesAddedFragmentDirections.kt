...
public class AttributesAddedFragmentDirections private constructor() {
  private data class ActionAttributesAddedFragmentToVariationListFragment(
    public val remoteProductId: Long = 0L
  ) : NavDirections {
    public override val actionId: Int = R.id.action_attributesAddedFragment_to_variationListFragment
  ...
  private data class ActionAttributesAddedFragmentToProductDetailFragment(
    public val remoteProductId: Long = 0L,
    public val isAddProduct: Boolean = false,
    public val isTrashEnabled: Boolean = false
  ) : NavDirections {
    public override val actionId: Int = R.id.action_attributesAddedFragment_to_productDetailFragment
  ...
  public companion object {
    public fun actionAttributesAddedFragmentToVariationListFragment(remoteProductId: Long = 0L):
        NavDirections = ActionAttributesAddedFragmentToVariationListFragment(remoteProductId)

    public fun actionAttributesAddedFragmentToProductDetailFragment(
      remoteProductId: Long = 0L,
      isAddProduct: Boolean = false,
      isTrashEnabled: Boolean = false
    ): NavDirections = ActionAttributesAddedFragmentToProductDetailFragment(remoteProductId,
