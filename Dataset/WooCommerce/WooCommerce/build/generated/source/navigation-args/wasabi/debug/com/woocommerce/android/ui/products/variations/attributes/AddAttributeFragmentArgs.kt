...
public data class AddAttributeFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AddAttributeFragmentArgs {
      bundle.setClassLoader(AddAttributeFragmentArgs::class.java.classLoader)
      ...
      return AddAttributeFragmentArgs(__isVariationCreation)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): AddAttributeFragmentArgs {
      val __isVariationCreation : Boolean?
