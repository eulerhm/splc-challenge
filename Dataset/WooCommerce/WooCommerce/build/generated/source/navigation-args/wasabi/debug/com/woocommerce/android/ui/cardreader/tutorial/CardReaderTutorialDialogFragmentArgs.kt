...
public data class CardReaderTutorialDialogFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): CardReaderTutorialDialogFragmentArgs {
      bundle.setClassLoader(CardReaderTutorialDialogFragmentArgs::class.java.classLoader)
      ...
      return CardReaderTutorialDialogFragmentArgs(__cardReaderFlowParam)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        CardReaderTutorialDialogFragmentArgs {
      val __cardReaderFlowParam : CardReaderFlowParam?
