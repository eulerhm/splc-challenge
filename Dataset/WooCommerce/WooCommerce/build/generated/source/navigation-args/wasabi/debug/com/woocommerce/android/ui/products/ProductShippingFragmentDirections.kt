...
public class ProductShippingFragmentDirections private constructor() {
  private data class ActionProductShippingFragmentToProductShippingClassFragment(
    public val productShippingClassId: Long
  ) : NavDirections {
    public override val actionId: Int =
        R.id.action_productShippingFragment_to_productShippingClassFragment
  ...
  public companion object {
    public
        fun actionProductShippingFragmentToProductShippingClassFragment(productShippingClassId: Long):
        NavDirections =
        ActionProductShippingFragmentToProductShippingClassFragment(productShippingClassId)
