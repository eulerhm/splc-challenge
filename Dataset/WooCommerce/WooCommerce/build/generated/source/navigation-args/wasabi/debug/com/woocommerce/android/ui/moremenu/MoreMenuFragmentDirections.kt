...
public class MoreMenuFragmentDirections private constructor() {
  public companion object {
    public fun actionMoreMenuToReviewList(): NavDirections =
        ActionOnlyNavDirections(R.id.action_moreMenu_to_reviewList)

    public fun actionMoreMenuToSettingsActivity(): NavDirections =
        ActionOnlyNavDirections(R.id.action_moreMenu_to_settingsActivity)

    public fun actionMoreMenuFragmentToInboxFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_moreMenuFragment_to_inboxFragment)

    public fun actionMoreMenuToCouponListFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_moreMenu_to_couponListFragment)
