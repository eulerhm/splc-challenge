...
public class MyStoreFragmentDirections private constructor() {
  public companion object {
    public fun actionMyStoreToJetpackBenefitsDialog(): NavDirections =
        ActionOnlyNavDirections(R.id.action_myStore_to_jetpackBenefitsDialog)
