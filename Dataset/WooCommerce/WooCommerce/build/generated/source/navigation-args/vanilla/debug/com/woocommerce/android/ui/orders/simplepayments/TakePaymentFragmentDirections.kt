...
public class TakePaymentFragmentDirections private constructor() {
  private data class ActionTakePaymentFragmentToCardReaderFlow(
    public val cardReaderFlowParam: CardReaderFlowParam
  ) : NavDirections {
    public override val actionId: Int = R.id.action_takePaymentFragment_to_cardReaderFlow
  ...
  public companion object {
    public fun actionTakePaymentFragmentToCardReaderFlow(cardReaderFlowParam: CardReaderFlowParam):
        NavDirections = ActionTakePaymentFragmentToCardReaderFlow(cardReaderFlowParam)
  }
}
