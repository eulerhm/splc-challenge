...
public data class FeedbackSurveyFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FeedbackSurveyFragmentArgs {
      bundle.setClassLoader(FeedbackSurveyFragmentArgs::class.java.classLoader)
      ...
      if (bundle.containsKey("surveyType")) {
        ...
        __surveyType = SurveyType.MAIN
      }
      return FeedbackSurveyFragmentArgs(__surveyType)
    }
