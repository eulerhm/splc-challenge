...
public data class ProductSettingsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ProductSettingsFragmentArgs {
      bundle.setClassLoader(ProductSettingsFragmentArgs::class.java.classLoader)
      ...
      return ProductSettingsFragmentArgs(__remoteProductId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ProductSettingsFragmentArgs {
      val __remoteProductId : Long?
