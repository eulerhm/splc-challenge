...
final class GeneratedAppGlideModuleImpl extends GeneratedAppGlideModule {
  private final WooCommerceGlideModule appGlideModule;

  public GeneratedAppGlideModuleImpl(Context context) {
    appGlideModule = new WooCommerceGlideModule();
    if (Log.isLoggable("Glide", Log.DEBUG)) {
      Log.d("Glide", "Discovered AppGlideModule from annotation: com.woocommerce.android.di.WooCommerceGlideModule");
