 ...
 */
public abstract class Hilt_OrderCreationProductDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationProductDetailsFragment() {
    super();
  }

  Hilt_OrderCreationProductDetailsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationProductDetailsFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationProductDetailsFragment(UnsafeCasts.<OrderCreationProductDetailsFragment>unsafeCast(this));
    }
  }
