 ...
 */
public abstract class Hilt_ProductTagsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductTagsFragment() {
    super();
  }

  Hilt_ProductTagsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductTagsFragment_GeneratedInjector) this.generatedComponent()).injectProductTagsFragment(UnsafeCasts.<ProductTagsFragment>unsafeCast(this));
    }
  }
