 ...
 */
public abstract class Hilt_SearchFilterFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchFilterFragment() {
    super();
  }

  Hilt_SearchFilterFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchFilterFragment_GeneratedInjector) this.generatedComponent()).injectSearchFilterFragment(UnsafeCasts.<SearchFilterFragment>unsafeCast(this));
    }
  }
