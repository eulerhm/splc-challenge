 ...
 */
public abstract class Hilt_EditShippingLabelPaymentFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditShippingLabelPaymentFragment() {
    super();
  }

  Hilt_EditShippingLabelPaymentFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditShippingLabelPaymentFragment_GeneratedInjector) this.generatedComponent()).injectEditShippingLabelPaymentFragment(UnsafeCasts.<EditShippingLabelPaymentFragment>unsafeCast(this));
    }
  }
