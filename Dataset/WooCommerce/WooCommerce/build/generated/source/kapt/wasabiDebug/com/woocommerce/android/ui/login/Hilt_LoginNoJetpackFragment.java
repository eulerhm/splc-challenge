 ...
 */
public abstract class Hilt_LoginNoJetpackFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginNoJetpackFragment() {
    super();
  }

  Hilt_LoginNoJetpackFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginNoJetpackFragment_GeneratedInjector) this.generatedComponent()).injectLoginNoJetpackFragment(UnsafeCasts.<LoginNoJetpackFragment>unsafeCast(this));
    }
  }
