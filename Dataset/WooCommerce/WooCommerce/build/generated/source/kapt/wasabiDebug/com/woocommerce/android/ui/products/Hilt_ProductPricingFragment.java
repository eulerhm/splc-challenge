 ...
 */
public abstract class Hilt_ProductPricingFragment extends BaseProductEditorFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductPricingFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductPricingFragment_GeneratedInjector) this.generatedComponent()).injectProductPricingFragment(UnsafeCasts.<ProductPricingFragment>unsafeCast(this));
    }
  }
