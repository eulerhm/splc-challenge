 ...
 */
public abstract class Hilt_ShippingLabelAddressSuggestionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingLabelAddressSuggestionFragment() {
    super();
  }

  Hilt_ShippingLabelAddressSuggestionFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingLabelAddressSuggestionFragment_GeneratedInjector) this.generatedComponent()).injectShippingLabelAddressSuggestionFragment(UnsafeCasts.<ShippingLabelAddressSuggestionFragment>unsafeCast(this));
    }
  }
