 ...
 */
public abstract class Hilt_ShippingPackageSelectorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingPackageSelectorFragment() {
    super();
  }

  Hilt_ShippingPackageSelectorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingPackageSelectorFragment_GeneratedInjector) this.generatedComponent()).injectShippingPackageSelectorFragment(UnsafeCasts.<ShippingPackageSelectorFragment>unsafeCast(this));
    }
  }
