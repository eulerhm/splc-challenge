 ...
 */
public abstract class Hilt_AddProductCategoryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddProductCategoryFragment() {
    super();
  }

  Hilt_AddProductCategoryFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProductCategoryFragment_GeneratedInjector) this.generatedComponent()).injectAddProductCategoryFragment(UnsafeCasts.<AddProductCategoryFragment>unsafeCast(this));
    }
  }
