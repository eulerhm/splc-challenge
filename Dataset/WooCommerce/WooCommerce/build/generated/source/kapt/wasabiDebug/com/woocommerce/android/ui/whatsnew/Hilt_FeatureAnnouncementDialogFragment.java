 ...
 */
public abstract class Hilt_FeatureAnnouncementDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FeatureAnnouncementDialogFragment() {
    super();
  }

  Hilt_FeatureAnnouncementDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeatureAnnouncementDialogFragment_GeneratedInjector) this.generatedComponent()).injectFeatureAnnouncementDialogFragment(UnsafeCasts.<FeatureAnnouncementDialogFragment>unsafeCast(this));
    }
  }
