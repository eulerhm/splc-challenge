 ...
 */
public abstract class Hilt_ShippingLabelCreateCustomPackageFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingLabelCreateCustomPackageFragment() {
    super();
  }

  Hilt_ShippingLabelCreateCustomPackageFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingLabelCreateCustomPackageFragment_GeneratedInjector) this.generatedComponent()).injectShippingLabelCreateCustomPackageFragment(UnsafeCasts.<ShippingLabelCreateCustomPackageFragment>unsafeCast(this));
    }
  }
