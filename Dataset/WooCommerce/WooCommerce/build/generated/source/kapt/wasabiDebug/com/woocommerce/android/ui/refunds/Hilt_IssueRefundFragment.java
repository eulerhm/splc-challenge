 ...
 */
public abstract class Hilt_IssueRefundFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IssueRefundFragment() {
    super();
  }

  Hilt_IssueRefundFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IssueRefundFragment_GeneratedInjector) this.generatedComponent()).injectIssueRefundFragment(UnsafeCasts.<IssueRefundFragment>unsafeCast(this));
    }
  }
