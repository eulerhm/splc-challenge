 ...
 */
public abstract class Hilt_CustomerOrderNoteEditingFragment extends BaseOrderEditingFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CustomerOrderNoteEditingFragment() {
    super();
  }

  Hilt_CustomerOrderNoteEditingFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerOrderNoteEditingFragment_GeneratedInjector) this.generatedComponent()).injectCustomerOrderNoteEditingFragment(UnsafeCasts.<CustomerOrderNoteEditingFragment>unsafeCast(this));
    }
  }
