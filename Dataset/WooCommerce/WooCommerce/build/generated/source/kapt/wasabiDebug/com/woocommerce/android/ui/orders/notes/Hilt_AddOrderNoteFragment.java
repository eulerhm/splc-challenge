 ...
 */
public abstract class Hilt_AddOrderNoteFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddOrderNoteFragment() {
    super();
  }

  Hilt_AddOrderNoteFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddOrderNoteFragment_GeneratedInjector) this.generatedComponent()).injectAddOrderNoteFragment(UnsafeCasts.<AddOrderNoteFragment>unsafeCast(this));
    }
  }
