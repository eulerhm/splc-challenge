 ...
 */
public abstract class Hilt_WPComWebViewFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WPComWebViewFragment() {
    super();
  }

  Hilt_WPComWebViewFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WPComWebViewFragment_GeneratedInjector) this.generatedComponent()).injectWPComWebViewFragment(UnsafeCasts.<WPComWebViewFragment>unsafeCast(this));
    }
  }
