 ...
 */
public abstract class Hilt_ShippingCarrierRatesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingCarrierRatesFragment() {
    super();
  }

  Hilt_ShippingCarrierRatesFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingCarrierRatesFragment_GeneratedInjector) this.generatedComponent()).injectShippingCarrierRatesFragment(UnsafeCasts.<ShippingCarrierRatesFragment>unsafeCast(this));
    }
  }
