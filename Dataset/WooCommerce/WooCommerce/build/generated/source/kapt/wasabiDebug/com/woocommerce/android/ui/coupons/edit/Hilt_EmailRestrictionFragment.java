 ...
 */
public abstract class Hilt_EmailRestrictionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EmailRestrictionFragment() {
    super();
  }

  Hilt_EmailRestrictionFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmailRestrictionFragment_GeneratedInjector) this.generatedComponent()).injectEmailRestrictionFragment(UnsafeCasts.<EmailRestrictionFragment>unsafeCast(this));
    }
  }
