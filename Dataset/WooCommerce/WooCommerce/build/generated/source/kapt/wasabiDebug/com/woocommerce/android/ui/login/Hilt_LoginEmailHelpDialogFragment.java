 ...
 */
public abstract class Hilt_LoginEmailHelpDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginEmailHelpDialogFragment() {
    super();
  }

  Hilt_LoginEmailHelpDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginEmailHelpDialogFragment_GeneratedInjector) this.generatedComponent()).injectLoginEmailHelpDialogFragment(UnsafeCasts.<LoginEmailHelpDialogFragment>unsafeCast(this));
    }
  }
