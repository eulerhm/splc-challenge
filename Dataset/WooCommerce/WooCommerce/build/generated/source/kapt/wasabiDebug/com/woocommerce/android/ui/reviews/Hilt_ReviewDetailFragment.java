 ...
 */
public abstract class Hilt_ReviewDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReviewDetailFragment() {
    super();
  }

  Hilt_ReviewDetailFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReviewDetailFragment_GeneratedInjector) this.generatedComponent()).injectReviewDetailFragment(UnsafeCasts.<ReviewDetailFragment>unsafeCast(this));
    }
  }
