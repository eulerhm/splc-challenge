 ...
 */
public abstract class Hilt_CouponDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CouponDetailsFragment() {
    super();
  }

  Hilt_CouponDetailsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CouponDetailsFragment_GeneratedInjector) this.generatedComponent()).injectCouponDetailsFragment(UnsafeCasts.<CouponDetailsFragment>unsafeCast(this));
    }
  }
