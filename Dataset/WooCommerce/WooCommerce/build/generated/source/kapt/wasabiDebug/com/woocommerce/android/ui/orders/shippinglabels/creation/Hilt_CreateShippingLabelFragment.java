 ...
 */
public abstract class Hilt_CreateShippingLabelFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateShippingLabelFragment() {
    super();
  }

  Hilt_CreateShippingLabelFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateShippingLabelFragment_GeneratedInjector) this.generatedComponent()).injectCreateShippingLabelFragment(UnsafeCasts.<CreateShippingLabelFragment>unsafeCast(this));
    }
  }
