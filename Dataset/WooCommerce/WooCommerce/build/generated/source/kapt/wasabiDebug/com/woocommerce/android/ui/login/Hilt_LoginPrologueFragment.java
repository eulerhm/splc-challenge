 ...
 */
public abstract class Hilt_LoginPrologueFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginPrologueFragment() {
    super();
  }

  Hilt_LoginPrologueFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginPrologueFragment_GeneratedInjector) this.generatedComponent()).injectLoginPrologueFragment(UnsafeCasts.<LoginPrologueFragment>unsafeCast(this));
    }
  }
