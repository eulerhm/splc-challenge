 ...
 */
public abstract class Hilt_PrivacySettingsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrivacySettingsFragment() {
    super();
  }

  Hilt_PrivacySettingsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivacySettingsFragment_GeneratedInjector) this.generatedComponent()).injectPrivacySettingsFragment(UnsafeCasts.<PrivacySettingsFragment>unsafeCast(this));
    }
  }
