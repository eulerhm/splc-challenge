 ...
 */
public abstract class Hilt_OrderCreationFormFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationFormFragment() {
    super();
  }

  Hilt_OrderCreationFormFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationFormFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationFormFragment(UnsafeCasts.<OrderCreationFormFragment>unsafeCast(this));
    }
  }
