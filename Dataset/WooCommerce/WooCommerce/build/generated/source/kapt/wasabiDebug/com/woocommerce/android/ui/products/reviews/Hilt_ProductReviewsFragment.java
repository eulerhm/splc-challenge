 ...
 */
public abstract class Hilt_ProductReviewsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductReviewsFragment() {
    super();
  }

  Hilt_ProductReviewsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductReviewsFragment_GeneratedInjector) this.generatedComponent()).injectProductReviewsFragment(UnsafeCasts.<ProductReviewsFragment>unsafeCast(this));
    }
  }
