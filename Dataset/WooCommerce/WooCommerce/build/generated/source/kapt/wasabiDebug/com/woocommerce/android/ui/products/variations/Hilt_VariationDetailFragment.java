 ...
 */
public abstract class Hilt_VariationDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VariationDetailFragment() {
    super();
  }

  Hilt_VariationDetailFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VariationDetailFragment_GeneratedInjector) this.generatedComponent()).injectVariationDetailFragment(UnsafeCasts.<VariationDetailFragment>unsafeCast(this));
    }
  }
