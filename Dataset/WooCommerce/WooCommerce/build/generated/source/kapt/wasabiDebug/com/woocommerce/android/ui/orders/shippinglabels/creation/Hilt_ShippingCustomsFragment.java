 ...
 */
public abstract class Hilt_ShippingCustomsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingCustomsFragment() {
    super();
  }

  Hilt_ShippingCustomsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingCustomsFragment_GeneratedInjector) this.generatedComponent()).injectShippingCustomsFragment(UnsafeCasts.<ShippingCustomsFragment>unsafeCast(this));
    }
  }
