 ...
 */
public abstract class Hilt_VariationSelectorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VariationSelectorFragment() {
    super();
  }

  Hilt_VariationSelectorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VariationSelectorFragment_GeneratedInjector) this.generatedComponent()).injectVariationSelectorFragment(UnsafeCasts.<VariationSelectorFragment>unsafeCast(this));
    }
  }
