 ...
 */
public abstract class Hilt_RefundAmountDialog extends CurrencyAmountDialog implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundAmountDialog_GeneratedInjector) this.generatedComponent()).injectRefundAmountDialog(UnsafeCasts.<RefundAmountDialog>unsafeCast(this));
    }
  }
