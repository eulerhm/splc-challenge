 ...
 */
public abstract class Hilt_AddOrderShipmentTrackingFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddOrderShipmentTrackingFragment() {
    super();
  }

  Hilt_AddOrderShipmentTrackingFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddOrderShipmentTrackingFragment_GeneratedInjector) this.generatedComponent()).injectAddOrderShipmentTrackingFragment(UnsafeCasts.<AddOrderShipmentTrackingFragment>unsafeCast(this));
    }
  }
