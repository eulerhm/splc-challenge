 ...
 */
public abstract class Hilt_MediaUploadErrorListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MediaUploadErrorListFragment() {
    super();
  }

  Hilt_MediaUploadErrorListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MediaUploadErrorListFragment_GeneratedInjector) this.generatedComponent()).injectMediaUploadErrorListFragment(UnsafeCasts.<MediaUploadErrorListFragment>unsafeCast(this));
    }
  }
