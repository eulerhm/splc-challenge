 ...
 */
public abstract class Hilt_LoginDiscoveryErrorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginDiscoveryErrorFragment() {
    super();
  }

  Hilt_LoginDiscoveryErrorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginDiscoveryErrorFragment_GeneratedInjector) this.generatedComponent()).injectLoginDiscoveryErrorFragment(UnsafeCasts.<LoginDiscoveryErrorFragment>unsafeCast(this));
    }
  }
