 ...
 */
public abstract class Hilt_ProductShippingClassFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductShippingClassFragment() {
    super();
  }

  Hilt_ProductShippingClassFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductShippingClassFragment_GeneratedInjector) this.generatedComponent()).injectProductShippingClassFragment(UnsafeCasts.<ProductShippingClassFragment>unsafeCast(this));
    }
  }
