 ...
 */
public abstract class Hilt_AddProductDownloadBottomSheetFragment extends WCBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProductDownloadBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectAddProductDownloadBottomSheetFragment(UnsafeCasts.<AddProductDownloadBottomSheetFragment>unsafeCast(this));
    }
  }
