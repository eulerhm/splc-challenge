 ...
 */
public abstract class Hilt_MagicLinkInterceptFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MagicLinkInterceptFragment() {
    super();
  }

  Hilt_MagicLinkInterceptFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MagicLinkInterceptFragment_GeneratedInjector) this.generatedComponent()).injectMagicLinkInterceptFragment(UnsafeCasts.<MagicLinkInterceptFragment>unsafeCast(this));
    }
  }
