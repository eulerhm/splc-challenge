 ...
 */
public abstract class Hilt_SimplePaymentsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SimplePaymentsFragment() {
    super();
  }

  Hilt_SimplePaymentsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimplePaymentsFragment_GeneratedInjector) this.generatedComponent()).injectSimplePaymentsFragment(UnsafeCasts.<SimplePaymentsFragment>unsafeCast(this));
    }
  }
