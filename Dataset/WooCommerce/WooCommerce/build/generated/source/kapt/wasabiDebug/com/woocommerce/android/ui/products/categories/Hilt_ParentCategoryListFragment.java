 ...
 */
public abstract class Hilt_ParentCategoryListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ParentCategoryListFragment() {
    super();
  }

  Hilt_ParentCategoryListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ParentCategoryListFragment_GeneratedInjector) this.generatedComponent()).injectParentCategoryListFragment(UnsafeCasts.<ParentCategoryListFragment>unsafeCast(this));
    }
  }
