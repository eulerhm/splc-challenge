 ...
 */
public abstract class Hilt_VariationsBulkUpdateAttrPickerDialog extends WCBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VariationsBulkUpdateAttrPickerDialog_GeneratedInjector) this.generatedComponent()).injectVariationsBulkUpdateAttrPickerDialog(UnsafeCasts.<VariationsBulkUpdateAttrPickerDialog>unsafeCast(this));
    }
  }
