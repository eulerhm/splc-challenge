 ...
 */
public abstract class Hilt_CardReaderPaymentDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderPaymentDialogFragment() {
    super();
  }

  Hilt_CardReaderPaymentDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderPaymentDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderPaymentDialogFragment(UnsafeCasts.<CardReaderPaymentDialogFragment>unsafeCast(this));
    }
  }
