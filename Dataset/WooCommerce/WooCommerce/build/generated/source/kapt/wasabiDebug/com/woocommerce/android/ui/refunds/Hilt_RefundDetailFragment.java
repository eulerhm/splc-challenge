 ...
 */
public abstract class Hilt_RefundDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RefundDetailFragment() {
    super();
  }

  Hilt_RefundDetailFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundDetailFragment_GeneratedInjector) this.generatedComponent()).injectRefundDetailFragment(UnsafeCasts.<RefundDetailFragment>unsafeCast(this));
    }
  }
