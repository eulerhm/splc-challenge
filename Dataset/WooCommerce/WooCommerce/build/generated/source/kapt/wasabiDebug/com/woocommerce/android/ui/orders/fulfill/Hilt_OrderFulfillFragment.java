 ...
 */
public abstract class Hilt_OrderFulfillFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderFulfillFragment() {
    super();
  }

  Hilt_OrderFulfillFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderFulfillFragment_GeneratedInjector) this.generatedComponent()).injectOrderFulfillFragment(UnsafeCasts.<OrderFulfillFragment>unsafeCast(this));
    }
  }
