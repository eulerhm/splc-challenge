 ...
 */
public abstract class Hilt_RefundItemsPickerDialog extends NumberPickerDialog implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundItemsPickerDialog_GeneratedInjector) this.generatedComponent()).injectRefundItemsPickerDialog(UnsafeCasts.<RefundItemsPickerDialog>unsafeCast(this));
    }
  }
