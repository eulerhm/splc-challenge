 ...
 */
public abstract class Hilt_ProductShippingFragment extends BaseProductEditorFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductShippingFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductShippingFragment_GeneratedInjector) this.generatedComponent()).injectProductShippingFragment(UnsafeCasts.<ProductShippingFragment>unsafeCast(this));
    }
  }
