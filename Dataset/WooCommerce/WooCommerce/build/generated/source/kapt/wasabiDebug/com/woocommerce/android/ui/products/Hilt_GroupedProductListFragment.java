 ...
 */
public abstract class Hilt_GroupedProductListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GroupedProductListFragment() {
    super();
  }

  Hilt_GroupedProductListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GroupedProductListFragment_GeneratedInjector) this.generatedComponent()).injectGroupedProductListFragment(UnsafeCasts.<GroupedProductListFragment>unsafeCast(this));
    }
  }
