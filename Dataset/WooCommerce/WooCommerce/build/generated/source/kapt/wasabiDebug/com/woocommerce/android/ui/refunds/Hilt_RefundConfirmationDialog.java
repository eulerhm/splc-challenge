 ...
 */
public abstract class Hilt_RefundConfirmationDialog extends ConfirmationDialog implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundConfirmationDialog_GeneratedInjector) this.generatedComponent()).injectRefundConfirmationDialog(UnsafeCasts.<RefundConfirmationDialog>unsafeCast(this));
    }
  }
