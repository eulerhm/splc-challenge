 ...
 */
public abstract class Hilt_ProductDetailBottomSheetFragment extends WCBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDetailBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectProductDetailBottomSheetFragment(UnsafeCasts.<ProductDetailBottomSheetFragment>unsafeCast(this));
    }
  }
