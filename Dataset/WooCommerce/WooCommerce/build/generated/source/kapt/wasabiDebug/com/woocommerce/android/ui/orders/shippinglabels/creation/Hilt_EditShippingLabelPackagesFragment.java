 ...
 */
public abstract class Hilt_EditShippingLabelPackagesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditShippingLabelPackagesFragment() {
    super();
  }

  Hilt_EditShippingLabelPackagesFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditShippingLabelPackagesFragment_GeneratedInjector) this.generatedComponent()).injectEditShippingLabelPackagesFragment(UnsafeCasts.<EditShippingLabelPackagesFragment>unsafeCast(this));
    }
  }
