 ...
 */
public abstract class Hilt_RefundByItemsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RefundByItemsFragment() {
    super();
  }

  Hilt_RefundByItemsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundByItemsFragment_GeneratedInjector) this.generatedComponent()).injectRefundByItemsFragment(UnsafeCasts.<RefundByItemsFragment>unsafeCast(this));
    }
  }
