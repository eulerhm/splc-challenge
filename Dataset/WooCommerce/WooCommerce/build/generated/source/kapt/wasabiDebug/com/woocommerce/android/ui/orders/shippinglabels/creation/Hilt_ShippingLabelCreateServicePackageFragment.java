 ...
 */
public abstract class Hilt_ShippingLabelCreateServicePackageFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingLabelCreateServicePackageFragment() {
    super();
  }

  Hilt_ShippingLabelCreateServicePackageFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingLabelCreateServicePackageFragment_GeneratedInjector) this.generatedComponent()).injectShippingLabelCreateServicePackageFragment(UnsafeCasts.<ShippingLabelCreateServicePackageFragment>unsafeCast(this));
    }
  }
