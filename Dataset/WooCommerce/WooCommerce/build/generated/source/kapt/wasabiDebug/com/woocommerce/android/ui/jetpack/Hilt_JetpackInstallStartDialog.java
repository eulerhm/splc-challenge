 ...
 */
public abstract class Hilt_JetpackInstallStartDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JetpackInstallStartDialog() {
    super();
  }

  Hilt_JetpackInstallStartDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JetpackInstallStartDialog_GeneratedInjector) this.generatedComponent()).injectJetpackInstallStartDialog(UnsafeCasts.<JetpackInstallStartDialog>unsafeCast(this));
    }
  }
