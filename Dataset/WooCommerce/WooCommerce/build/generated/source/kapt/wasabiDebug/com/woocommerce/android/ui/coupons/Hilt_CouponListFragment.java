 ...
 */
public abstract class Hilt_CouponListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CouponListFragment() {
    super();
  }

  Hilt_CouponListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CouponListFragment_GeneratedInjector) this.generatedComponent()).injectCouponListFragment(UnsafeCasts.<CouponListFragment>unsafeCast(this));
    }
  }
