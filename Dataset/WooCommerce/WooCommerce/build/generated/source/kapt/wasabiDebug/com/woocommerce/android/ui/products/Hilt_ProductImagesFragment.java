 ...
 */
public abstract class Hilt_ProductImagesFragment extends BaseProductEditorFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductImagesFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductImagesFragment_GeneratedInjector) this.generatedComponent()).injectProductImagesFragment(UnsafeCasts.<ProductImagesFragment>unsafeCast(this));
    }
  }
