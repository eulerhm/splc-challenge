...
public abstract class Hilt_MyStoreFragment extends TopLevelFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyStoreFragment() {
    super();
  }

  Hilt_MyStoreFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyStoreFragment_GeneratedInjector) this.generatedComponent()).injectMyStoreFragment(UnsafeCasts.<MyStoreFragment>unsafeCast(this));
    }
  }
