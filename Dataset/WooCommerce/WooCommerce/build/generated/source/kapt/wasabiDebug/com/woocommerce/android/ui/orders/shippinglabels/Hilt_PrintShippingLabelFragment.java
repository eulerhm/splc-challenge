 ...
 */
public abstract class Hilt_PrintShippingLabelFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrintShippingLabelFragment() {
    super();
  }

  Hilt_PrintShippingLabelFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrintShippingLabelFragment_GeneratedInjector) this.generatedComponent()).injectPrintShippingLabelFragment(UnsafeCasts.<PrintShippingLabelFragment>unsafeCast(this));
    }
  }
