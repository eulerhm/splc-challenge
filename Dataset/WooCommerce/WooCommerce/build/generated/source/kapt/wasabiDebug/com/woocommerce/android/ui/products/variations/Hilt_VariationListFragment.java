 ...
 */
public abstract class Hilt_VariationListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VariationListFragment() {
    super();
  }

  Hilt_VariationListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VariationListFragment_GeneratedInjector) this.generatedComponent()).injectVariationListFragment(UnsafeCasts.<VariationListFragment>unsafeCast(this));
    }
  }
