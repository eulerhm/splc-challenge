 ...
 */
public abstract class Hilt_ProductAddonsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductAddonsFragment() {
    super();
  }

  Hilt_ProductAddonsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductAddonsFragment_GeneratedInjector) this.generatedComponent()).injectProductAddonsFragment(UnsafeCasts.<ProductAddonsFragment>unsafeCast(this));
    }
  }
