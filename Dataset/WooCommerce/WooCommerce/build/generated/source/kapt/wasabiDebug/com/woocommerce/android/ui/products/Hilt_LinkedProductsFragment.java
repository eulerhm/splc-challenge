 ...
 */
public abstract class Hilt_LinkedProductsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LinkedProductsFragment() {
    super();
  }

  Hilt_LinkedProductsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LinkedProductsFragment_GeneratedInjector) this.generatedComponent()).injectLinkedProductsFragment(UnsafeCasts.<LinkedProductsFragment>unsafeCast(this));
    }
  }
