 ...
 */
public abstract class Hilt_AddOrderTrackingProviderListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddOrderTrackingProviderListFragment() {
    super();
  }

  Hilt_AddOrderTrackingProviderListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddOrderTrackingProviderListFragment_GeneratedInjector) this.generatedComponent()).injectAddOrderTrackingProviderListFragment(UnsafeCasts.<AddOrderTrackingProviderListFragment>unsafeCast(this));
    }
  }
