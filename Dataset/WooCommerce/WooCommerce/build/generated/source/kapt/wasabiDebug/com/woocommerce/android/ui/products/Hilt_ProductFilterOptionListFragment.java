 ...
 */
public abstract class Hilt_ProductFilterOptionListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductFilterOptionListFragment() {
    super();
  }

  Hilt_ProductFilterOptionListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductFilterOptionListFragment_GeneratedInjector) this.generatedComponent()).injectProductFilterOptionListFragment(UnsafeCasts.<ProductFilterOptionListFragment>unsafeCast(this));
    }
  }
