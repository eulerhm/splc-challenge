 ...
 */
public abstract class Hilt_EditShippingLabelAddressFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditShippingLabelAddressFragment() {
    super();
  }

  Hilt_EditShippingLabelAddressFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditShippingLabelAddressFragment_GeneratedInjector) this.generatedComponent()).injectEditShippingLabelAddressFragment(UnsafeCasts.<EditShippingLabelAddressFragment>unsafeCast(this));
    }
  }
