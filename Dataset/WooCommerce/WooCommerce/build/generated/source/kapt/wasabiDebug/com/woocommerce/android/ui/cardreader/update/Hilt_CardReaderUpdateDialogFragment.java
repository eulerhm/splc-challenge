 ...
 */
public abstract class Hilt_CardReaderUpdateDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderUpdateDialogFragment() {
    super();
  }

  Hilt_CardReaderUpdateDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderUpdateDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderUpdateDialogFragment(UnsafeCasts.<CardReaderUpdateDialogFragment>unsafeCast(this));
    }
  }
