 ...
 */
public abstract class Hilt_OrderFilterOptionsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderFilterOptionsFragment() {
    super();
  }

  Hilt_OrderFilterOptionsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderFilterOptionsFragment_GeneratedInjector) this.generatedComponent()).injectOrderFilterOptionsFragment(UnsafeCasts.<OrderFilterOptionsFragment>unsafeCast(this));
    }
  }
