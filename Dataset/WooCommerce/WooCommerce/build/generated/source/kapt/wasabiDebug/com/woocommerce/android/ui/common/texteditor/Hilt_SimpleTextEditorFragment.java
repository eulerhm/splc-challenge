 ...
 */
public abstract class Hilt_SimpleTextEditorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SimpleTextEditorFragment() {
    super();
  }

  Hilt_SimpleTextEditorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimpleTextEditorFragment_GeneratedInjector) this.generatedComponent()).injectSimpleTextEditorFragment(UnsafeCasts.<SimpleTextEditorFragment>unsafeCast(this));
    }
  }
