 ...
 */
public abstract class Hilt_OrderCreationShippingFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationShippingFragment() {
    super();
  }

  Hilt_OrderCreationShippingFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationShippingFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationShippingFragment(UnsafeCasts.<OrderCreationShippingFragment>unsafeCast(this));
    }
  }
