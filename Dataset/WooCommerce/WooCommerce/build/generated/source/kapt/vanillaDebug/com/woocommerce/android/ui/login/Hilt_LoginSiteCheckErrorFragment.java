 ...
 */
public abstract class Hilt_LoginSiteCheckErrorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginSiteCheckErrorFragment() {
    super();
  }

  Hilt_LoginSiteCheckErrorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginSiteCheckErrorFragment_GeneratedInjector) this.generatedComponent()).injectLoginSiteCheckErrorFragment(UnsafeCasts.<LoginSiteCheckErrorFragment>unsafeCast(this));
    }
  }
