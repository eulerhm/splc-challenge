 ...
 */
public abstract class Hilt_ProductSettingsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductSettingsFragment() {
    super();
  }

  Hilt_ProductSettingsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductSettingsFragment_GeneratedInjector) this.generatedComponent()).injectProductSettingsFragment(UnsafeCasts.<ProductSettingsFragment>unsafeCast(this));
    }
  }
