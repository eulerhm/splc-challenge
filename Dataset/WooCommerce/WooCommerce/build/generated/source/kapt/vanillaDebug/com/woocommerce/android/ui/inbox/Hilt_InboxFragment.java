 ...
 */
public abstract class Hilt_InboxFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InboxFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InboxFragment_GeneratedInjector) this.generatedComponent()).injectInboxFragment(UnsafeCasts.<InboxFragment>unsafeCast(this));
    }
  }
