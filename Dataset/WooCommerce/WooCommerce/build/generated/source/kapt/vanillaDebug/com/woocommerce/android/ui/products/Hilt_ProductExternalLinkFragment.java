 ...
 */
public abstract class Hilt_ProductExternalLinkFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductExternalLinkFragment() {
    super();
  }

  Hilt_ProductExternalLinkFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductExternalLinkFragment_GeneratedInjector) this.generatedComponent()).injectProductExternalLinkFragment(UnsafeCasts.<ProductExternalLinkFragment>unsafeCast(this));
    }
  }
