 ...
 */
public abstract class Hilt_LoginNoWPcomAccountFoundFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginNoWPcomAccountFoundFragment() {
    super();
  }

  Hilt_LoginNoWPcomAccountFoundFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginNoWPcomAccountFoundFragment_GeneratedInjector) this.generatedComponent()).injectLoginNoWPcomAccountFoundFragment(UnsafeCasts.<LoginNoWPcomAccountFoundFragment>unsafeCast(this));
    }
  }
