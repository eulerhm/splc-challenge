 ...
 */
public abstract class Hilt_ReceiptPreviewFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReceiptPreviewFragment() {
    super();
  }

  Hilt_ReceiptPreviewFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReceiptPreviewFragment_GeneratedInjector) this.generatedComponent()).injectReceiptPreviewFragment(UnsafeCasts.<ReceiptPreviewFragment>unsafeCast(this));
    }
  }
