 ...
 */
public abstract class Hilt_CardReaderConnectDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderConnectDialogFragment() {
    super();
  }

  Hilt_CardReaderConnectDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderConnectDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderConnectDialogFragment(UnsafeCasts.<CardReaderConnectDialogFragment>unsafeCast(this));
    }
  }
