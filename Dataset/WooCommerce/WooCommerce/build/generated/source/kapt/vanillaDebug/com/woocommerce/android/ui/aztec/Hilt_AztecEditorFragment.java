 ...
 */
public abstract class Hilt_AztecEditorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AztecEditorFragment() {
    super();
  }

  Hilt_AztecEditorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AztecEditorFragment_GeneratedInjector) this.generatedComponent()).injectAztecEditorFragment(UnsafeCasts.<AztecEditorFragment>unsafeCast(this));
    }
  }
