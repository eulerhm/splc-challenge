 ...
 */
public abstract class Hilt_AttributeListFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AttributeListFragment() {
    super();
  }

  Hilt_AttributeListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AttributeListFragment_GeneratedInjector) this.generatedComponent()).injectAttributeListFragment(UnsafeCasts.<AttributeListFragment>unsafeCast(this));
    }
  }
