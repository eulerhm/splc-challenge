 ...
 */
public abstract class Hilt_JetpackInstallProgressDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JetpackInstallProgressDialog() {
    super();
  }

  Hilt_JetpackInstallProgressDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JetpackInstallProgressDialog_GeneratedInjector) this.generatedComponent()).injectJetpackInstallProgressDialog(UnsafeCasts.<JetpackInstallProgressDialog>unsafeCast(this));
    }
  }
