 ...
 */
public abstract class Hilt_CardReaderDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderDetailFragment() {
    super();
  }

  Hilt_CardReaderDetailFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderDetailFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderDetailFragment(UnsafeCasts.<CardReaderDetailFragment>unsafeCast(this));
    }
  }
