 ...
 */
public abstract class Hilt_SitePickerFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SitePickerFragment() {
    super();
  }

  Hilt_SitePickerFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SitePickerFragment_GeneratedInjector) this.generatedComponent()).injectSitePickerFragment(UnsafeCasts.<SitePickerFragment>unsafeCast(this));
    }
  }
