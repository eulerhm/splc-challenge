 ...
 */
public abstract class Hilt_CardReaderHubFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderHubFragment() {
    super();
  }

  Hilt_CardReaderHubFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderHubFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderHubFragment(UnsafeCasts.<CardReaderHubFragment>unsafeCast(this));
    }
  }
