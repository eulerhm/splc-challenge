 ...
 */
public abstract class Hilt_ProductSortingFragment extends WCBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductSortingFragment_GeneratedInjector) this.generatedComponent()).injectProductSortingFragment(UnsafeCasts.<ProductSortingFragment>unsafeCast(this));
    }
  }
