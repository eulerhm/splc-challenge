 ...
 */
public abstract class Hilt_ProductSelectionListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductSelectionListFragment() {
    super();
  }

  Hilt_ProductSelectionListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductSelectionListFragment_GeneratedInjector) this.generatedComponent()).injectProductSelectionListFragment(UnsafeCasts.<ProductSelectionListFragment>unsafeCast(this));
    }
  }
