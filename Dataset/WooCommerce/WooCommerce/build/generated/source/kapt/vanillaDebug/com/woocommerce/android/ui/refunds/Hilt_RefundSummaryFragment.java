 ...
 */
public abstract class Hilt_RefundSummaryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RefundSummaryFragment() {
    super();
  }

  Hilt_RefundSummaryFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundSummaryFragment_GeneratedInjector) this.generatedComponent()).injectRefundSummaryFragment(UnsafeCasts.<RefundSummaryFragment>unsafeCast(this));
    }
  }
