 ...
 */
public abstract class Hilt_OrderCreationProductSelectionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationProductSelectionFragment() {
    super();
  }

  Hilt_OrderCreationProductSelectionFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationProductSelectionFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationProductSelectionFragment(UnsafeCasts.<OrderCreationProductSelectionFragment>unsafeCast(this));
    }
  }
