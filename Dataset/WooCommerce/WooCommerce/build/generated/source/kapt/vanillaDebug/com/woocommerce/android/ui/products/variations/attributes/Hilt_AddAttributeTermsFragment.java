 ...
 */
public abstract class Hilt_AddAttributeTermsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddAttributeTermsFragment() {
    super();
  }

  Hilt_AddAttributeTermsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAttributeTermsFragment_GeneratedInjector) this.generatedComponent()).injectAddAttributeTermsFragment(UnsafeCasts.<AddAttributeTermsFragment>unsafeCast(this));
    }
  }
