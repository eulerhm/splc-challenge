 ...
 */
public abstract class Hilt_PrintShippingLabelCustomsFormFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrintShippingLabelCustomsFormFragment() {
    super();
  }

  Hilt_PrintShippingLabelCustomsFormFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrintShippingLabelCustomsFormFragment_GeneratedInjector) this.generatedComponent()).injectPrintShippingLabelCustomsFormFragment(UnsafeCasts.<PrintShippingLabelCustomsFormFragment>unsafeCast(this));
    }
  }
