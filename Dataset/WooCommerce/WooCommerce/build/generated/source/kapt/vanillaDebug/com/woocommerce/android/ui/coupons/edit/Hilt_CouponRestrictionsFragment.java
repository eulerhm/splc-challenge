 ...
 */
public abstract class Hilt_CouponRestrictionsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CouponRestrictionsFragment() {
    super();
  }

  Hilt_CouponRestrictionsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CouponRestrictionsFragment_GeneratedInjector) this.generatedComponent()).injectCouponRestrictionsFragment(UnsafeCasts.<CouponRestrictionsFragment>unsafeCast(this));
    }
  }
