 ...
 */
public abstract class Hilt_MoveShippingItemDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoveShippingItemDialog() {
    super();
  }

  Hilt_MoveShippingItemDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoveShippingItemDialog_GeneratedInjector) this.generatedComponent()).injectMoveShippingItemDialog(UnsafeCasts.<MoveShippingItemDialog>unsafeCast(this));
    }
  }
