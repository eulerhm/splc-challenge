 ...
 */
public abstract class Hilt_CardReaderTutorialDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderTutorialDialogFragment() {
    super();
  }

  Hilt_CardReaderTutorialDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderTutorialDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderTutorialDialogFragment(UnsafeCasts.<CardReaderTutorialDialogFragment>unsafeCast(this));
    }
  }
