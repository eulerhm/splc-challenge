 ...
 */
public abstract class Hilt_OrderedAddonFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderedAddonFragment() {
    super();
  }

  Hilt_OrderedAddonFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderedAddonFragment_GeneratedInjector) this.generatedComponent()).injectOrderedAddonFragment(UnsafeCasts.<OrderedAddonFragment>unsafeCast(this));
    }
  }
