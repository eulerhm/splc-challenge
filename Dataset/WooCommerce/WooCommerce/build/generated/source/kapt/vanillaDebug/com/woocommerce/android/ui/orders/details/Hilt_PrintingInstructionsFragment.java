 ...
 */
public abstract class Hilt_PrintingInstructionsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrintingInstructionsFragment() {
    super();
  }

  Hilt_PrintingInstructionsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrintingInstructionsFragment_GeneratedInjector) this.generatedComponent()).injectPrintingInstructionsFragment(UnsafeCasts.<PrintingInstructionsFragment>unsafeCast(this));
    }
  }
