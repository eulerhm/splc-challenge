 ...
 */
public abstract class Hilt_ShippingLabelCreatePackageFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingLabelCreatePackageFragment() {
    super();
  }

  Hilt_ShippingLabelCreatePackageFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingLabelCreatePackageFragment_GeneratedInjector) this.generatedComponent()).injectShippingLabelCreatePackageFragment(UnsafeCasts.<ShippingLabelCreatePackageFragment>unsafeCast(this));
    }
  }
