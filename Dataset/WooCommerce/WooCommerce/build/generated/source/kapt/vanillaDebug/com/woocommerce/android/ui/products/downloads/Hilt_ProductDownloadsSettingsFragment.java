 ...
 */
public abstract class Hilt_ProductDownloadsSettingsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDownloadsSettingsFragment() {
    super();
  }

  Hilt_ProductDownloadsSettingsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDownloadsSettingsFragment_GeneratedInjector) this.generatedComponent()).injectProductDownloadsSettingsFragment(UnsafeCasts.<ProductDownloadsSettingsFragment>unsafeCast(this));
    }
  }
