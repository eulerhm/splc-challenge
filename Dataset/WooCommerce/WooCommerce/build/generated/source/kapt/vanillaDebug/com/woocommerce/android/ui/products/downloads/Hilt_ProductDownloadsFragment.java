 ...
 */
public abstract class Hilt_ProductDownloadsFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDownloadsFragment() {
    super();
  }

  Hilt_ProductDownloadsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDownloadsFragment_GeneratedInjector) this.generatedComponent()).injectProductDownloadsFragment(UnsafeCasts.<ProductDownloadsFragment>unsafeCast(this));
    }
  }
