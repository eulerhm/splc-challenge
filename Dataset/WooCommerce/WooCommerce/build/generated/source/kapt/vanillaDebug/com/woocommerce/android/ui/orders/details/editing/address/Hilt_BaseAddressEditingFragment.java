 ...
 */
public abstract class Hilt_BaseAddressEditingFragment extends BaseOrderEditingFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BaseAddressEditingFragment() {
    super();
  }

  Hilt_BaseAddressEditingFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BaseAddressEditingFragment_GeneratedInjector) this.generatedComponent()).injectBaseAddressEditingFragment(UnsafeCasts.<BaseAddressEditingFragment>unsafeCast(this));
    }
  }
