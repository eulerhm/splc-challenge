 ...
 */
public abstract class Hilt_AddAttributeFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddAttributeFragment() {
    super();
  }

  Hilt_AddAttributeFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAttributeFragment_GeneratedInjector) this.generatedComponent()).injectAddAttributeFragment(UnsafeCasts.<AddAttributeFragment>unsafeCast(this));
    }
  }
