 ...
 */
public abstract class Hilt_EditVariationAttributesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditVariationAttributesFragment() {
    super();
  }

  Hilt_EditVariationAttributesFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditVariationAttributesFragment_GeneratedInjector) this.generatedComponent()).injectEditVariationAttributesFragment(UnsafeCasts.<EditVariationAttributesFragment>unsafeCast(this));
    }
  }
