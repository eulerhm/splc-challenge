 ...
 */
public abstract class Hilt_OrderFilterCategoriesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderFilterCategoriesFragment() {
    super();
  }

  Hilt_OrderFilterCategoriesFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderFilterCategoriesFragment_GeneratedInjector) this.generatedComponent()).injectOrderFilterCategoriesFragment(UnsafeCasts.<OrderFilterCategoriesFragment>unsafeCast(this));
    }
  }
