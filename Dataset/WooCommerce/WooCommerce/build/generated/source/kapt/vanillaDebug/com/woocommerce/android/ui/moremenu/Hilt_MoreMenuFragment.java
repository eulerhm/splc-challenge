 ...
 */
public abstract class Hilt_MoreMenuFragment extends TopLevelFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoreMenuFragment() {
    super();
  }

  Hilt_MoreMenuFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoreMenuFragment_GeneratedInjector) this.generatedComponent()).injectMoreMenuFragment(UnsafeCasts.<MoreMenuFragment>unsafeCast(this));
    }
  }
