 ...
 */
public abstract class Hilt_CardReaderWelcomeDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderWelcomeDialogFragment() {
    super();
  }

  Hilt_CardReaderWelcomeDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderWelcomeDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderWelcomeDialogFragment(UnsafeCasts.<CardReaderWelcomeDialogFragment>unsafeCast(this));
    }
  }
