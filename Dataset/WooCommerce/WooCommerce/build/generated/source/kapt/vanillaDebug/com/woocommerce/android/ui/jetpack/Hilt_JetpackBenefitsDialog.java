 ...
 */
public abstract class Hilt_JetpackBenefitsDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JetpackBenefitsDialog() {
    super();
  }

  Hilt_JetpackBenefitsDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JetpackBenefitsDialog_GeneratedInjector) this.generatedComponent()).injectJetpackBenefitsDialog(UnsafeCasts.<JetpackBenefitsDialog>unsafeCast(this));
    }
  }
