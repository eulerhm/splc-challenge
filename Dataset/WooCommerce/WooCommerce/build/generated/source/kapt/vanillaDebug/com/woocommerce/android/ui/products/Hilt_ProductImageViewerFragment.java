 ...
 */
public abstract class Hilt_ProductImageViewerFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductImageViewerFragment() {
    super();
  }

  Hilt_ProductImageViewerFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductImageViewerFragment_GeneratedInjector) this.generatedComponent()).injectProductImageViewerFragment(UnsafeCasts.<ProductImageViewerFragment>unsafeCast(this));
    }
  }
