 ...
 */
public abstract class Hilt_ProductCategoriesFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductCategoriesFragment() {
    super();
  }

  Hilt_ProductCategoriesFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductCategoriesFragment_GeneratedInjector) this.generatedComponent()).injectProductCategoriesFragment(UnsafeCasts.<ProductCategoriesFragment>unsafeCast(this));
    }
  }
