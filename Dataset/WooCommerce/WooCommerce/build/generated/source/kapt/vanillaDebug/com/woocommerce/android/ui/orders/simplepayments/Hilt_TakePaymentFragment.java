 ...
 */
public abstract class Hilt_TakePaymentFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TakePaymentFragment() {
    super();
  }

  Hilt_TakePaymentFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TakePaymentFragment_GeneratedInjector) this.generatedComponent()).injectTakePaymentFragment(UnsafeCasts.<TakePaymentFragment>unsafeCast(this));
    }
  }
