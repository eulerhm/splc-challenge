 ...
 */
public abstract class Hilt_OrderCreationFeeFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationFeeFragment() {
    super();
  }

  Hilt_OrderCreationFeeFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationFeeFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationFeeFragment(UnsafeCasts.<OrderCreationFeeFragment>unsafeCast(this));
    }
  }
