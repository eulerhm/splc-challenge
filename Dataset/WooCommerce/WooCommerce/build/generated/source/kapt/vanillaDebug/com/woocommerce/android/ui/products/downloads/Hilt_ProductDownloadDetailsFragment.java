 ...
 */
public abstract class Hilt_ProductDownloadDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDownloadDetailsFragment() {
    super();
  }

  Hilt_ProductDownloadDetailsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDownloadDetailsFragment_GeneratedInjector) this.generatedComponent()).injectProductDownloadDetailsFragment(UnsafeCasts.<ProductDownloadDetailsFragment>unsafeCast(this));
    }
  }
