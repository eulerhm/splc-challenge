 ...
 */
public abstract class Hilt_ProductTypesBottomSheetFragment extends WCBottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductTypesBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectProductTypesBottomSheetFragment(UnsafeCasts.<ProductTypesBottomSheetFragment>unsafeCast(this));
    }
  }
