 ...
 */
public abstract class Hilt_InstallWcShippingFlowFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InstallWcShippingFlowFragment() {
    super();
  }

  Hilt_InstallWcShippingFlowFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InstallWcShippingFlowFragment_GeneratedInjector) this.generatedComponent()).injectInstallWcShippingFlowFragment(UnsafeCasts.<InstallWcShippingFlowFragment>unsafeCast(this));
    }
  }
