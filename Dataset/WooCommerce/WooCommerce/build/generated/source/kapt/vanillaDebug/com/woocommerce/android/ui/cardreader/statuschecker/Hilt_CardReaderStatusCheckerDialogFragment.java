 ...
 */
public abstract class Hilt_CardReaderStatusCheckerDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderStatusCheckerDialogFragment() {
    super();
  }

  Hilt_CardReaderStatusCheckerDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderStatusCheckerDialogFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderStatusCheckerDialogFragment(UnsafeCasts.<CardReaderStatusCheckerDialogFragment>unsafeCast(this));
    }
  }
