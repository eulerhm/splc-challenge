 ...
 */
public abstract class Hilt_ProductInventoryFragment extends BaseProductEditorFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductInventoryFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductInventoryFragment_GeneratedInjector) this.generatedComponent()).injectProductInventoryFragment(UnsafeCasts.<ProductInventoryFragment>unsafeCast(this));
    }
  }
