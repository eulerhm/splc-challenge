 ...
 */
public abstract class Hilt_EditCouponFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditCouponFragment() {
    super();
  }

  Hilt_EditCouponFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditCouponFragment_GeneratedInjector) this.generatedComponent()).injectEditCouponFragment(UnsafeCasts.<EditCouponFragment>unsafeCast(this));
    }
  }
