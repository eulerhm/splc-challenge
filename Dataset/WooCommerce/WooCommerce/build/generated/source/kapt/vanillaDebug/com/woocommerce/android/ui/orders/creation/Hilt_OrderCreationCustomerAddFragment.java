 ...
 */
public abstract class Hilt_OrderCreationCustomerAddFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationCustomerAddFragment() {
    super();
  }

  Hilt_OrderCreationCustomerAddFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationCustomerAddFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationCustomerAddFragment(UnsafeCasts.<OrderCreationCustomerAddFragment>unsafeCast(this));
    }
  }
