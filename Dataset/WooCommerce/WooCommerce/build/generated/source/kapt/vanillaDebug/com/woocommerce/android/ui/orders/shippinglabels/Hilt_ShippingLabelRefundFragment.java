 ...
 */
public abstract class Hilt_ShippingLabelRefundFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShippingLabelRefundFragment() {
    super();
  }

  Hilt_ShippingLabelRefundFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShippingLabelRefundFragment_GeneratedInjector) this.generatedComponent()).injectShippingLabelRefundFragment(UnsafeCasts.<ShippingLabelRefundFragment>unsafeCast(this));
    }
  }
