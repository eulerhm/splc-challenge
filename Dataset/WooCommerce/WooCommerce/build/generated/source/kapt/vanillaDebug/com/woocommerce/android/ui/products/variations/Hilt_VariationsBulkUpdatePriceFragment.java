 ...
 */
public abstract class Hilt_VariationsBulkUpdatePriceFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VariationsBulkUpdatePriceFragment() {
    super();
  }

  Hilt_VariationsBulkUpdatePriceFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VariationsBulkUpdatePriceFragment_GeneratedInjector) this.generatedComponent()).injectVariationsBulkUpdatePriceFragment(UnsafeCasts.<VariationsBulkUpdatePriceFragment>unsafeCast(this));
    }
  }
