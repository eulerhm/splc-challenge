 ...
 */
public abstract class Hilt_CardReaderOnboardingFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderOnboardingFragment() {
    super();
  }

  Hilt_CardReaderOnboardingFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderOnboardingFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderOnboardingFragment(UnsafeCasts.<CardReaderOnboardingFragment>unsafeCast(this));
    }
  }
