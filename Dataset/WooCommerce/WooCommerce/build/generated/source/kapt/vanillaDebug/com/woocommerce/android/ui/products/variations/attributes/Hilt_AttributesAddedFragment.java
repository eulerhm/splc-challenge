 ...
 */
public abstract class Hilt_AttributesAddedFragment extends BaseProductFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AttributesAddedFragment() {
    super();
  }

  Hilt_AttributesAddedFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AttributesAddedFragment_GeneratedInjector) this.generatedComponent()).injectAttributesAddedFragment(UnsafeCasts.<AttributesAddedFragment>unsafeCast(this));
    }
  }
