 ...
 */
public abstract class Hilt_ProductSelectorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductSelectorFragment() {
    super();
  }

  Hilt_ProductSelectorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductSelectorFragment_GeneratedInjector) this.generatedComponent()).injectProductSelectorFragment(UnsafeCasts.<ProductSelectorFragment>unsafeCast(this));
    }
  }
