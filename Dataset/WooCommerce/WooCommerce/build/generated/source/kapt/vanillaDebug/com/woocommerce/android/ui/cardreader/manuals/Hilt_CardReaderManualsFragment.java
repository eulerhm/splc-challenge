 ...
 */
public abstract class Hilt_CardReaderManualsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardReaderManualsFragment() {
    super();
  }

  Hilt_CardReaderManualsFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardReaderManualsFragment_GeneratedInjector) this.generatedComponent()).injectCardReaderManualsFragment(UnsafeCasts.<CardReaderManualsFragment>unsafeCast(this));
    }
  }
