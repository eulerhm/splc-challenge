 ...
 */
public abstract class Hilt_OrderCreationVariationSelectionFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderCreationVariationSelectionFragment() {
    super();
  }

  Hilt_OrderCreationVariationSelectionFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderCreationVariationSelectionFragment_GeneratedInjector) this.generatedComponent()).injectOrderCreationVariationSelectionFragment(UnsafeCasts.<OrderCreationVariationSelectionFragment>unsafeCast(this));
    }
  }
