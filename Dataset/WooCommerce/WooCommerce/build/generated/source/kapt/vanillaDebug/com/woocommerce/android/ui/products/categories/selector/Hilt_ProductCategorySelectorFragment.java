 ...
 */
public abstract class Hilt_ProductCategorySelectorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductCategorySelectorFragment() {
    super();
  }

  Hilt_ProductCategorySelectorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductCategorySelectorFragment_GeneratedInjector) this.generatedComponent()).injectProductCategorySelectorFragment(UnsafeCasts.<ProductCategorySelectorFragment>unsafeCast(this));
    }
  }
