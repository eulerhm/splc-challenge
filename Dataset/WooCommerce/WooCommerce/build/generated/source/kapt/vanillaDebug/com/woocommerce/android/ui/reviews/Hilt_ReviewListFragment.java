 ...
 */
public abstract class Hilt_ReviewListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReviewListFragment() {
    super();
  }

  Hilt_ReviewListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReviewListFragment_GeneratedInjector) this.generatedComponent()).injectReviewListFragment(UnsafeCasts.<ReviewListFragment>unsafeCast(this));
    }
  }
