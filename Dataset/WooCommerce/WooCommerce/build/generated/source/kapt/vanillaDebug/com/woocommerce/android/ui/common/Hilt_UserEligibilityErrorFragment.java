 ...
 */
public abstract class Hilt_UserEligibilityErrorFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserEligibilityErrorFragment() {
    super();
  }

  Hilt_UserEligibilityErrorFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserEligibilityErrorFragment_GeneratedInjector) this.generatedComponent()).injectUserEligibilityErrorFragment(UnsafeCasts.<UserEligibilityErrorFragment>unsafeCast(this));
    }
  }
