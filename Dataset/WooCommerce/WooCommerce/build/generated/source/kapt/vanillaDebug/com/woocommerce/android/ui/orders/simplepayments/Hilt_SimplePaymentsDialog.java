 ...
 */
public abstract class Hilt_SimplePaymentsDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SimplePaymentsDialog() {
    super();
  }

  Hilt_SimplePaymentsDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimplePaymentsDialog_GeneratedInjector) this.generatedComponent()).injectSimplePaymentsDialog(UnsafeCasts.<SimplePaymentsDialog>unsafeCast(this));
    }
  }
