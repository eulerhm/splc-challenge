 ...
 */
public abstract class Hilt_ProductFilterListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductFilterListFragment() {
    super();
  }

  Hilt_ProductFilterListFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductFilterListFragment_GeneratedInjector) this.generatedComponent()).injectProductFilterListFragment(UnsafeCasts.<ProductFilterListFragment>unsafeCast(this));
    }
  }
