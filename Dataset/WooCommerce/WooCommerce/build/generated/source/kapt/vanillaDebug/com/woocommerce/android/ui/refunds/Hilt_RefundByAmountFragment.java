 ...
 */
public abstract class Hilt_RefundByAmountFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RefundByAmountFragment() {
    super();
  }

  Hilt_RefundByAmountFragment(int layoutId) {
    super(layoutId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RefundByAmountFragment_GeneratedInjector) this.generatedComponent()).injectRefundByAmountFragment(UnsafeCasts.<RefundByAmountFragment>unsafeCast(this));
    }
  }
