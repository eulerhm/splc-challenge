...
public final class SkeletonVariationDetailBinding implements ViewBinding {
  @NonNull
  ...
  private SkeletonVariationDetailBinding(@NonNull LinearLayout rootView, @NonNull View divider,
      ...
      @NonNull View viewImage1, @NonNull View viewOrdersLabel, @NonNull View viewOrdersTotal,
      @NonNull View viewProductExtIcon, @NonNull View viewProductExternal,
      @NonNull View viewReviewsCount, @NonNull View viewReviewsLabel, @NonNull View viewTitle) {
  ...
  @NonNull
  public static SkeletonVariationDetailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SkeletonVariationDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.skeleton_variation_detail, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SkeletonVariationDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SkeletonVariationDetailBinding((LinearLayout) rootView, divider, divider1,
          divider2, divider3, divider4, viewDescription, viewDescriptionLabel, viewImage1,
