...
public class MyLocationOptedInUseCase extends com.google.samples.apps.iosched.shared.domain.UseCase<kotlin.Unit, java.lang.Boolean> {
    ...
    @javax.inject.Inject()
    public MyLocationOptedInUseCase(@org.jetbrains.annotations.NotNull()
