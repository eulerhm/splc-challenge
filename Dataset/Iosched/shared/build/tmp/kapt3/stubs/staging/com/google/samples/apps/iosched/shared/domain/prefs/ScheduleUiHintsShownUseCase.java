...
public class ScheduleUiHintsShownUseCase extends com.google.samples.apps.iosched.shared.domain.UseCase<kotlin.Unit, java.lang.Boolean> {
    ...
    @javax.inject.Inject()
    public ScheduleUiHintsShownUseCase(@org.jetbrains.annotations.NotNull()
