...
public class LoadUserSessionsUseCase extends com.google.samples.apps.iosched.shared.domain.FlowUseCase<kotlin.Pair<? extends java.lang.String, ? extends java.util.Set<? extends java.lang.String>>, java.util.List<? extends com.google.samples.apps.iosched.model.userdata.UserSession>> {
    ...
    kotlin.Pair<java.lang.String, ? extends java.util.Set<java.lang.String>> parameters) {
        return null;
    }
    
    @javax.inject.Inject()
    public LoadUserSessionsUseCase(@org.jetbrains.annotations.NotNull()
