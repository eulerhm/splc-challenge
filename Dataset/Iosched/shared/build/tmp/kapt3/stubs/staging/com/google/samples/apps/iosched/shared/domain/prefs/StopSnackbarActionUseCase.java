...
public class StopSnackbarActionUseCase extends com.google.samples.apps.iosched.shared.domain.UseCase<java.lang.Boolean, kotlin.Unit> {
    ...
    @javax.inject.Inject()
    public StopSnackbarActionUseCase(@org.jetbrains.annotations.NotNull()
