...
public class SwapActionUseCase extends com.google.samples.apps.iosched.shared.domain.UseCase<com.google.samples.apps.iosched.shared.domain.users.SwapRequestParameters, com.google.samples.apps.iosched.shared.domain.users.SwapRequestAction> {
    ...
    com.google.samples.apps.iosched.shared.domain.users.SwapRequestParameters p0, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super com.google.samples.apps.iosched.shared.domain.users.SwapRequestAction> p1) {
        return null;
    }
    
    @javax.inject.Inject()
    public SwapActionUseCase(@org.jetbrains.annotations.NotNull()
