...
@OriginatingElement(
    topLevelClass = SettingsTest.class
)
@GeneratedEntryPoint
@InstallIn(ApplicationComponent.class)
@Generated("dagger.hilt.processor.internal.root.TestInjectorGenerator")
public interface SettingsTest_GeneratedInjector extends TestInjector<SettingsTest> {
  void injectTest(SettingsTest settingsTest);
}
