...
public final class DaggerCodelabTest_HiltComponents_ApplicationC extends CodelabTest_HiltComponents.ApplicationC {
  ...
  private DaggerCodelabTest_HiltComponents_ApplicationC(AppModule appModuleParam,
  ...
  @Override
  public void injectTest(CodelabTest codelabTest) {
  }
  ...
  public static final class Builder {
    ...
    public CodelabTest_HiltComponents.ApplicationC build() {
      if (appModule == null) {
      ...
      return new DaggerCodelabTest_HiltComponents_ApplicationC(appModule, applicationContextModule, featureFlagsModule, filtersViewModelDelegateModule, sharedModule, signInModule, signInViewModelDelegateModule);
    }
  }

  private final class ActivityRetainedCBuilder implements CodelabTest_HiltComponents.ActivityRetainedC.Builder {
    @Override
    public CodelabTest_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl();
    }
  }

  private final class ActivityRetainedCImpl extends CodelabTest_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCBuilder implements CodelabTest_HiltComponents.ActivityC.Builder {
      ...
      @Override
      public CodelabTest_HiltComponents.ActivityC build() {
        Preconditions.checkBuilderRequirement(activity, Activity.class);
        return new ActivityCImpl(new EventActionsViewModelDelegateModule(), activity);
      }
    }

    private final class ActivityCImpl extends CodelabTest_HiltComponents.ActivityC {
      ...
      private LoadAgendaUseCase getLoadAgendaUseCase() {
        return new LoadAgendaUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getAgendaRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetTimeZoneUseCase getGetTimeZoneUseCase() {
        return new GetTimeZoneUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadAnnouncementsUseCase getLoadAnnouncementsUseCase() {
        return new LoadAnnouncementsUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getFeedRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private AnnouncementsViewModel_AssistedFactory getAnnouncementsViewModel_AssistedFactory() {
        return AnnouncementsViewModel_AssistedFactory_Factory.newInstance(getLoadAnnouncementsUseCaseProvider(), getGetTimeZoneUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getTimeProviderProvider());
      }
      ...
      private LoadCodelabsUseCase getLoadCodelabsUseCase() {
        return new LoadCodelabsUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getCodelabsRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetCodelabsInfoCardShownUseCase getGetCodelabsInfoCardShownUseCase() {
        return new GetCodelabsInfoCardShownUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetCodelabsInfoCardShownUseCase getSetCodelabsInfoCardShownUseCase() {
        return new SetCodelabsInfoCardShownUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private WifiInstaller getWifiInstaller() {
        return new WifiInstaller(DaggerCodelabTest_HiltComponents_ApplicationC.this.getWifiManager(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getClipboardManager());
      }
      ...
      private EventInfoViewModel_AssistedFactory getEventInfoViewModel_AssistedFactory() {
        return EventInfoViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getLoadWifiInfoUseCaseProvider(), getWifiInstallerProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider());
      }
      ...
      private LoadCurrentMomentUseCase getLoadCurrentMomentUseCase() {
        return new LoadCurrentMomentUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getFeedRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadStarredAndReservedSessionsUseCase getLoadStarredAndReservedSessionsUseCase() {
        return new LoadStarredAndReservedSessionsUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetConferenceStateUseCase getGetConferenceStateUseCase() {
        return new GetConferenceStateUseCase(TestCoroutinesModule_ProvidesMainDispatcherFactory.providesMainDispatcher(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getTimeProvider());
      }
      ...
      private FeedViewModel_AssistedFactory getFeedViewModel_AssistedFactory() {
        return FeedViewModel_AssistedFactory_Factory.newInstance(getLoadCurrentMomentUseCaseProvider(), getLoadAnnouncementsUseCaseProvider(), getLoadStarredAndReservedSessionsUseCaseProvider(), getGetTimeZoneUseCaseProvider(), getGetConferenceStateUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getTimeProviderProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider());
      }
      ...
      private OnboardingCompletedUseCase getOnboardingCompletedUseCase() {
        return new OnboardingCompletedUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadPinnedSessionsJsonUseCase getLoadPinnedSessionsJsonUseCase() {
        return new LoadPinnedSessionsJsonUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getGson(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadArDebugFlagUseCase getLoadArDebugFlagUseCase() {
        return new LoadArDebugFlagUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getArDebugFlagEndpoint(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MainActivityViewModel_AssistedFactory getMainActivityViewModel_AssistedFactory() {
        return MainActivityViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider(), getLoadPinnedSessionsJsonUseCaseProvider(), getLoadArDebugFlagUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getApplicationContextContextProvider());
      }
      ...
      private LoadGeoJsonFeaturesUseCase getLoadGeoJsonFeaturesUseCase() {
        return new LoadGeoJsonFeaturesUseCase(ApplicationContextModule_ProvideContextFactory.provideContext(DaggerCodelabTest_HiltComponents_ApplicationC.this.applicationContextModule), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private OptIntoMyLocationUseCase getOptIntoMyLocationUseCase() {
        return new OptIntoMyLocationUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MyLocationOptedInUseCase getMyLocationOptedInUseCase() {
        return new MyLocationOptedInUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MapViewModel_AssistedFactory getMapViewModel_AssistedFactory() {
        return MapViewModel_AssistedFactory_Factory.newInstance(getLoadGeoJsonFeaturesUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getOptIntoMyLocationUseCaseProvider(), getMyLocationOptedInUseCaseProvider());
      }
      ...
      private OnboardingCompleteActionUseCase getOnboardingCompleteActionUseCase() {
        return new OnboardingCompleteActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private OnboardingViewModel_AssistedFactory getOnboardingViewModel_AssistedFactory() {
        return OnboardingViewModel_AssistedFactory_Factory.newInstance(getOnboardingCompleteActionUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider());
      }
      ...
      private LoadUserSessionUseCase getLoadUserSessionUseCase() {
        return new LoadUserSessionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ReservationActionUseCase getReservationActionUseCase() {
        return new ReservationActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getStarReserveNotificationAlarmUpdater(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private RemoveReservationViewModel_AssistedFactory getRemoveReservationViewModel_AssistedFactory(
        ...
        return RemoveReservationViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getReservationActionUseCaseProvider());
      }
      ...
      private LoadScheduleUserSessionsUseCase getLoadScheduleUserSessionsUseCase() {
        return new LoadScheduleUserSessionsUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private StarEventAndNotifyUseCase getStarEventAndNotifyUseCase() {
        return new StarEventAndNotifyUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getStarReserveNotificationAlarmUpdater(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ScheduleUiHintsShownUseCase getScheduleUiHintsShownUseCase() {
        return new ScheduleUiHintsShownUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private RefreshConferenceDataUseCase getRefreshConferenceDataUseCase() {
        return new RefreshConferenceDataUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ObserveConferenceDataUseCase getObserveConferenceDataUseCase() {
        return new ObserveConferenceDataUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SessionSearchUseCase getSessionSearchUseCase() {
        return new SessionSearchUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionTextMatchStrategy(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadSearchFiltersUseCase getLoadSearchFiltersUseCase() {
        return new LoadSearchFiltersUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getTagRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SearchViewModel_AssistedFactory getSearchViewModel_AssistedFactory() {
        return SearchViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), getSessionSearchUseCaseProvider(), getGetTimeZoneUseCaseProvider(), getLoadSearchFiltersUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getFiltersViewModelDelegateProvider());
      }
      ...
      private LoadUserSessionsUseCase getLoadUserSessionsUseCase() {
        return new LoadUserSessionsUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private NetworkUtils getNetworkUtils() {
        return new NetworkUtils(ApplicationContextModule_ProvideContextFactory.provideContext(DaggerCodelabTest_HiltComponents_ApplicationC.this.applicationContextModule));
      }
      ...
      private SessionDetailViewModel_AssistedFactory getSessionDetailViewModel_AssistedFactory() {
        return SessionDetailViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getLoadUserSessionsUseCaseProvider(), getStarEventAndNotifyUseCaseProvider(), getReservationActionUseCaseProvider(), getGetTimeZoneUseCaseProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManagerProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getTimeProviderProvider(), getNetworkUtilsProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getReservationEnabledFlagBooleanProvider(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getDefaultDispatcherCoroutineDispatcherProvider());
      }
      ...
      private FeedbackUseCase getFeedbackUseCase() {
        return new FeedbackUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getFeedbackEndpoint(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SessionFeedbackViewModel_AssistedFactory getSessionFeedbackViewModel_AssistedFactory(
        ...
        return SessionFeedbackViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getFeedbackUseCaseProvider());
      }
      ...
      private SetTimeZoneUseCase getSetTimeZoneUseCase() {
        return new SetTimeZoneUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private NotificationsPrefSaveActionUseCase getNotificationsPrefSaveActionUseCase() {
        return new NotificationsPrefSaveActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetNotificationsSettingUseCase getGetNotificationsSettingUseCase() {
        return new GetNotificationsSettingUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetAnalyticsSettingUseCase getSetAnalyticsSettingUseCase() {
        return new SetAnalyticsSettingUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetAnalyticsSettingUseCase getGetAnalyticsSettingUseCase() {
        return new GetAnalyticsSettingUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetThemeUseCase getSetThemeUseCase() {
        return new SetThemeUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SignInViewModel_AssistedFactory getSignInViewModel_AssistedFactory() {
        return SignInViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider());
      }
      ...
      private StopSnackbarActionUseCase getStopSnackbarActionUseCase() {
        return new StopSnackbarActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadSpeakerUseCase getLoadSpeakerUseCase() {
        return new LoadSpeakerUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private EventActionsViewModelDelegate getEventActionsViewModelDelegate() {
        return EventActionsViewModelDelegateModule_ProvideEventActionsViewModelDelegateFactory.provideEventActionsViewModelDelegate(eventActionsViewModelDelegateModule, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegate(), getStarEventAndNotifyUseCase(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager(), DaggerCodelabTest_HiltComponents_ApplicationC.this.getApplicationScopeCoroutineScope(), TestCoroutinesModule_ProvidesMainDispatcherFactory.providesMainDispatcher());
      }
      ...
      private ThemeViewModel_AssistedFactory getThemeViewModel_AssistedFactory() {
        return ThemeViewModel_AssistedFactory_Factory.newInstance(DaggerCodelabTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider());
      }
      ...
      private ViewModelProvider.Factory getProvideFactory() {
        return ViewModelFactoryModules_ActivityModule_ProvideFactoryFactory.provideFactory(activity, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerCodelabTest_HiltComponents_ApplicationC.this.applicationContextModule), getMapOfStringAndProviderOfViewModelAssistedFactoryOf());
      }
      ...
      private MainActivity injectMainActivity2(MainActivity instance) {
        MainActivity_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
        MainActivity_MembersInjector.injectConnectivityManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getConnectivityManager());
        MainActivity_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
        MainActivity_MembersInjector.injectMapFeatureEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
        MainActivity_MembersInjector.injectCodelabsFeatureEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getCodelabsEnabledFlagBoolean());
        MainActivity_MembersInjector.injectExploreArFeatureEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getExploreArEnabledFlagBoolean());
        return instance;
      }

      @CanIgnoreReturnValue
      private SessionDetailActivity injectSessionDetailActivity2(SessionDetailActivity instance) {
        SessionDetailActivity_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
        return instance;
      }

      private final class FragmentCBuilder implements CodelabTest_HiltComponents.FragmentC.Builder {
        ...
        @Override
        public CodelabTest_HiltComponents.FragmentC build() {
          Preconditions.checkBuilderRequirement(fragment, Fragment.class);
          return new FragmentCImpl(new SessionViewPoolModule(), fragment);
        }
      }

      private final class FragmentCImpl extends CodelabTest_HiltComponents.FragmentC {
        ...
        private SwapActionUseCase getSwapActionUseCase() {
          return new SwapActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private MarkScheduleUiHintsShownUseCase getMarkScheduleUiHintsShownUseCase() {
          return new MarkScheduleUiHintsShownUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private NotificationsPrefShownActionUseCase getNotificationsPrefShownActionUseCase() {
          return new NotificationsPrefShownActionUseCase(DaggerCodelabTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private ViewModelProvider.Factory getProvideFactory() {
          return ViewModelFactoryModules_FragmentModule_ProvideFactoryFactory.provideFactory(fragment, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerCodelabTest_HiltComponents_ApplicationC.this.applicationContextModule), ActivityCImpl.this.getMapOfStringAndProviderOfViewModelAssistedFactoryOf());
        }
        ...
        private CodelabsFragment injectCodelabsFragment2(CodelabsFragment instance) {
          ...
          CodelabsFragment_MembersInjector.injectMapFeatureEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
          CodelabsFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private AnnouncementsFragment injectAnnouncementsFragment2(AnnouncementsFragment instance) {
          AnnouncementsFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private FeedFragment injectFeedFragment2(FeedFragment instance) {
          FeedFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          FeedFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private EventFragment injectEventFragment2(EventFragment instance) {
          EventFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          EventFragment_MembersInjector.injectAssistantAppEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAssistantAppEnabledFlagBoolean());
          return instance;
        }

        @CanIgnoreReturnValue
        private InfoFragment injectInfoFragment2(InfoFragment instance) {
          InfoFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private MapFragment injectMapFragment2(MapFragment instance) {
          MapFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }
        ...
        private ScheduleFragment injectScheduleFragment2(ScheduleFragment instance) {
          ScheduleFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          ScheduleFragment_MembersInjector.injectTagViewPool(instance, getNamedRecycledViewPool());
          ScheduleFragment_MembersInjector.injectSearchScheduleFeatureEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSearchScheduleEnabledFlagBoolean());
          ScheduleFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          return instance;
        }
        ...
        private SearchFragment injectSearchFragment2(SearchFragment instance) {
          SearchFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
        ...
        private SessionDetailFragment injectSessionDetailFragment2(SessionDetailFragment instance) {
          SessionDetailFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          SessionDetailFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          SessionDetailFragment_MembersInjector.injectTagRecycledViewPool(instance, getNamedRecycledViewPool());
          SessionDetailFragment_MembersInjector.injectIsMapEnabled(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
          return instance;
        }
        ...
        private SignInDialogFragment injectSignInDialogFragment2(SignInDialogFragment instance) {
          SignInDialogFragment_MembersInjector.injectSignInHandler(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInHandler());
          return instance;
        }

        @CanIgnoreReturnValue
        private SignOutDialogFragment injectSignOutDialogFragment2(SignOutDialogFragment instance) {
          SignOutDialogFragment_MembersInjector.injectSignInHandler(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInHandler());
          return instance;
        }

        @CanIgnoreReturnValue
        private SpeakerFragment injectSpeakerFragment2(SpeakerFragment instance) {
          SpeakerFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          SpeakerFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          SpeakerFragment_MembersInjector.injectTagRecycledViewPool(instance, getNamedRecycledViewPool());
          return instance;
        }

        private final class ViewWithFragmentCBuilder implements CodelabTest_HiltComponents.ViewWithFragmentC.Builder {
          private View view;
          ...
          @Override
          public CodelabTest_HiltComponents.ViewWithFragmentC build() {
            Preconditions.checkBuilderRequirement(view, View.class);
            return new ViewWithFragmentCImpl(view);
          }
        }

        private final class ViewWithFragmentCImpl extends CodelabTest_HiltComponents.ViewWithFragmentC {
      ...
      private final class ViewCBuilder implements CodelabTest_HiltComponents.ViewC.Builder {
        private View view;
        ...
        @Override
        public CodelabTest_HiltComponents.ViewC build() {
          Preconditions.checkBuilderRequirement(view, View.class);
          return new ViewCImpl(view);
        }
      }

      private final class ViewCImpl extends CodelabTest_HiltComponents.ViewC {
  ...
  private final class ServiceCBuilder implements CodelabTest_HiltComponents.ServiceC.Builder {
    ...
    @Override
    public CodelabTest_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(service);
    }
  }

  private final class ServiceCImpl extends CodelabTest_HiltComponents.ServiceC {
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getTimeProvider();

        case 1: // com.google.samples.apps.iosched.shared.domain.logistics.LoadWifiInfoUseCase 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getLoadWifiInfoUseCase();

        case 2: // com.google.samples.apps.iosched.shared.analytics.AnalyticsHelper 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getAnalyticsHelper();

        case 3: // com.google.samples.apps.iosched.ui.signin.SignInViewModelDelegate 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegate();

        case 4: // com.google.samples.apps.iosched.ui.theme.ThemedActivityDelegate 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getThemedActivityDelegate();

        case 5: // @dagger.hilt.android.qualifiers.ApplicationContext android.content.Context 
        return (T) ApplicationContextModule_ProvideContextFactory.provideContext(DaggerCodelabTest_HiltComponents_ApplicationC.this.applicationContextModule);

        case 6: // com.google.samples.apps.iosched.shared.fcm.TopicSubscriber 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getTopicSubscriber();

        case 7: // com.google.samples.apps.iosched.ui.messages.SnackbarMessageManager 
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager();

        case 8: // com.google.samples.apps.iosched.ui.filters.FiltersViewModelDelegate 
        return (T) FiltersViewModelDelegateModule_ProvideFiltersViewModelDelegateFactory.provideFiltersViewModelDelegate(DaggerCodelabTest_HiltComponents_ApplicationC.this.filtersViewModelDelegateModule);

        case 9: // @com.google.samples.apps.iosched.shared.di.ReservationEnabledFlag java.lang.Boolean 
        return (T) (Boolean) DaggerCodelabTest_HiltComponents_ApplicationC.this.getReservationEnabledFlagBoolean();
        ...
        return (T) DaggerCodelabTest_HiltComponents_ApplicationC.this.getGetThemeUseCase();
