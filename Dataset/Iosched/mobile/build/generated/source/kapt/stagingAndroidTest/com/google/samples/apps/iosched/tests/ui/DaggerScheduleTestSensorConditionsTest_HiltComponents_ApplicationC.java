...
import com.google.samples.apps.iosched.tests.di.TestCoroutinesModule_ProvidesDefaultDispatcherFactory;
import com.google.samples.apps.iosched.tests.di.TestCoroutinesModule_ProvidesIoDispatcherFactory;
import com.google.samples.apps.iosched.tests.di.TestCoroutinesModule_ProvidesMainDispatcherFactory;
import com.google.samples.apps.iosched.tests.di.TestCoroutinesModule_ProvidesMainImmediateDispatcherFactory;
...
public final class DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC extends ScheduleTestSensorConditionsTest_HiltComponents.ApplicationC {
  ...
  private DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC(
      AppModule appModuleParam, ApplicationContextModule applicationContextModuleParam,
  ...
  private CoroutineScope getApplicationScopeCoroutineScope() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvidesApplicationScopeFactory.providesApplicationScope(appModule, TestCoroutinesModule_ProvidesDefaultDispatcherFactory.providesDefaultDispatcher());
  ...
  private ObserveUserAuthStateUseCase getObserveUserAuthStateUseCase() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = new ObserveUserAuthStateUseCase(getRegisteredUserDataSource(), getAuthStateUserDataSource(), getTopicSubscriber(), getApplicationScopeCoroutineScope(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  ...
  private NotificationsPrefIsShownUseCase getNotificationsPrefIsShownUseCase() {
    return new NotificationsPrefIsShownUseCase(preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  }
  ...
  private SignInViewModelDelegate getSignInViewModelDelegate() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = SignInViewModelDelegateModule_ProvideSignInViewModelDelegateFactory.provideSignInViewModelDelegate(signInViewModelDelegateModule, getObserveUserAuthStateUseCase(), getNotificationsPrefIsShownUseCase(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher(), TestCoroutinesModule_ProvidesMainDispatcherFactory.providesMainDispatcher(), getReservationEnabledFlagBoolean());
  ...
  private AnalyticsHelper getAnalyticsHelper() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideAnalyticsHelperFactory.provideAnalyticsHelper(appModule, getApplicationScopeCoroutineScope(), ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule), getSignInViewModelDelegate(), preferenceStorage());
  ...
  private LoadUserSessionOneShotUseCase getLoadUserSessionOneShotUseCase() {
    return new LoadUserSessionOneShotUseCase(getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  }

  private LoadSessionOneShotUseCase getLoadSessionOneShotUseCase() {
    return new LoadSessionOneShotUseCase(getSessionRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  }
  ...
  private SnackbarMessageManager getSnackbarMessageManager() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = new SnackbarMessageManager(preferenceStorage());
  ...
  private LoadWifiInfoUseCase getLoadWifiInfoUseCase() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        ...
        if (local instanceof MemoizedSentinel) {
          local = new LoadWifiInfoUseCase(getAppConfigDataSource(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  ...
  private ObserveThemeModeUseCase getObserveThemeModeUseCase() {
    return new ObserveThemeModeUseCase(preferenceStorage(), TestCoroutinesModule_ProvidesDefaultDispatcherFactory.providesDefaultDispatcher());
  }

  private GetThemeUseCase getGetThemeUseCase() {
    return new GetThemeUseCase(preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
  }
  ...
  @Override
  public void injectTest(ScheduleTestSensorConditionsTest scheduleTestSensorConditionsTest) {
  }
  ...
  public static final class Builder {
    ...
    public ScheduleTestSensorConditionsTest_HiltComponents.ApplicationC build() {
      if (appModule == null) {
      ...
      return new DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC(appModule, applicationContextModule, featureFlagsModule, filtersViewModelDelegateModule, sharedModule, signInModule, signInViewModelDelegateModule);
    }
  }

  private final class ActivityRetainedCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.ActivityRetainedC.Builder {
    @Override
    public ScheduleTestSensorConditionsTest_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl();
    }
  }

  private final class ActivityRetainedCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.ActivityC.Builder {
      ...
      @Override
      public ScheduleTestSensorConditionsTest_HiltComponents.ActivityC build() {
        Preconditions.checkBuilderRequirement(activity, Activity.class);
        return new ActivityCImpl(new EventActionsViewModelDelegateModule(), activity);
      }
    }

    private final class ActivityCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.ActivityC {
      ...
      private LoadAgendaUseCase getLoadAgendaUseCase() {
        return new LoadAgendaUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAgendaRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetTimeZoneUseCase getGetTimeZoneUseCase() {
        return new GetTimeZoneUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadAnnouncementsUseCase getLoadAnnouncementsUseCase() {
        return new LoadAnnouncementsUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getFeedRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private AnnouncementsViewModel_AssistedFactory getAnnouncementsViewModel_AssistedFactory() {
        return AnnouncementsViewModel_AssistedFactory_Factory.newInstance(getLoadAnnouncementsUseCaseProvider(), getGetTimeZoneUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTimeProviderProvider());
      }
      ...
      private LoadCodelabsUseCase getLoadCodelabsUseCase() {
        return new LoadCodelabsUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getCodelabsRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetCodelabsInfoCardShownUseCase getGetCodelabsInfoCardShownUseCase() {
        return new GetCodelabsInfoCardShownUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetCodelabsInfoCardShownUseCase getSetCodelabsInfoCardShownUseCase() {
        return new SetCodelabsInfoCardShownUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private WifiInstaller getWifiInstaller() {
        return new WifiInstaller(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getWifiManager(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getClipboardManager());
      }
      ...
      private EventInfoViewModel_AssistedFactory getEventInfoViewModel_AssistedFactory() {
        return EventInfoViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getLoadWifiInfoUseCaseProvider(), getWifiInstallerProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider());
      }
      ...
      private LoadCurrentMomentUseCase getLoadCurrentMomentUseCase() {
        return new LoadCurrentMomentUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getFeedRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadStarredAndReservedSessionsUseCase getLoadStarredAndReservedSessionsUseCase() {
        return new LoadStarredAndReservedSessionsUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetConferenceStateUseCase getGetConferenceStateUseCase() {
        return new GetConferenceStateUseCase(TestCoroutinesModule_ProvidesMainDispatcherFactory.providesMainDispatcher(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTimeProvider());
      }
      ...
      private FeedViewModel_AssistedFactory getFeedViewModel_AssistedFactory() {
        return FeedViewModel_AssistedFactory_Factory.newInstance(getLoadCurrentMomentUseCaseProvider(), getLoadAnnouncementsUseCaseProvider(), getLoadStarredAndReservedSessionsUseCaseProvider(), getGetTimeZoneUseCaseProvider(), getGetConferenceStateUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTimeProviderProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider());
      }
      ...
      private OnboardingCompletedUseCase getOnboardingCompletedUseCase() {
        return new OnboardingCompletedUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadPinnedSessionsJsonUseCase getLoadPinnedSessionsJsonUseCase() {
        return new LoadPinnedSessionsJsonUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getGson(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadArDebugFlagUseCase getLoadArDebugFlagUseCase() {
        return new LoadArDebugFlagUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getArDebugFlagEndpoint(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MainActivityViewModel_AssistedFactory getMainActivityViewModel_AssistedFactory() {
        return MainActivityViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider(), getLoadPinnedSessionsJsonUseCaseProvider(), getLoadArDebugFlagUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getApplicationContextContextProvider());
      }
      ...
      private LoadGeoJsonFeaturesUseCase getLoadGeoJsonFeaturesUseCase() {
        return new LoadGeoJsonFeaturesUseCase(ApplicationContextModule_ProvideContextFactory.provideContext(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.applicationContextModule), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private OptIntoMyLocationUseCase getOptIntoMyLocationUseCase() {
        return new OptIntoMyLocationUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MyLocationOptedInUseCase getMyLocationOptedInUseCase() {
        return new MyLocationOptedInUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private MapViewModel_AssistedFactory getMapViewModel_AssistedFactory() {
        return MapViewModel_AssistedFactory_Factory.newInstance(getLoadGeoJsonFeaturesUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getOptIntoMyLocationUseCaseProvider(), getMyLocationOptedInUseCaseProvider());
      }
      ...
      private OnboardingCompleteActionUseCase getOnboardingCompleteActionUseCase() {
        return new OnboardingCompleteActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private OnboardingViewModel_AssistedFactory getOnboardingViewModel_AssistedFactory() {
        return OnboardingViewModel_AssistedFactory_Factory.newInstance(getOnboardingCompleteActionUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider());
      }
      ...
      private LoadUserSessionUseCase getLoadUserSessionUseCase() {
        return new LoadUserSessionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ReservationActionUseCase getReservationActionUseCase() {
        return new ReservationActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getStarReserveNotificationAlarmUpdater(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private RemoveReservationViewModel_AssistedFactory getRemoveReservationViewModel_AssistedFactory(
        ...
        return RemoveReservationViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getReservationActionUseCaseProvider());
      }
      ...
      private LoadScheduleUserSessionsUseCase getLoadScheduleUserSessionsUseCase() {
        return new LoadScheduleUserSessionsUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private StarEventAndNotifyUseCase getStarEventAndNotifyUseCase() {
        return new StarEventAndNotifyUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getStarReserveNotificationAlarmUpdater(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ScheduleUiHintsShownUseCase getScheduleUiHintsShownUseCase() {
        return new ScheduleUiHintsShownUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private RefreshConferenceDataUseCase getRefreshConferenceDataUseCase() {
        return new RefreshConferenceDataUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ObserveConferenceDataUseCase getObserveConferenceDataUseCase() {
        return new ObserveConferenceDataUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private ScheduleViewModel_AssistedFactory getScheduleViewModel_AssistedFactory() {
        return ScheduleViewModel_AssistedFactory_Factory.newInstance(getLoadScheduleUserSessionsUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getStarEventAndNotifyUseCaseProvider(), getScheduleUiHintsShownUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTopicSubscriberProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManagerProvider(), getGetTimeZoneUseCaseProvider(), getRefreshConferenceDataUseCaseProvider(), getObserveConferenceDataUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider());
      }
      ...
      private SessionSearchUseCase getSessionSearchUseCase() {
        return new SessionSearchUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionTextMatchStrategy(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadSearchFiltersUseCase getLoadSearchFiltersUseCase() {
        return new LoadSearchFiltersUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTagRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SearchViewModel_AssistedFactory getSearchViewModel_AssistedFactory() {
        return SearchViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), getSessionSearchUseCaseProvider(), getGetTimeZoneUseCaseProvider(), getLoadSearchFiltersUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getFiltersViewModelDelegateProvider());
      }
      ...
      private LoadUserSessionsUseCase getLoadUserSessionsUseCase() {
        return new LoadUserSessionsUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private NetworkUtils getNetworkUtils() {
        return new NetworkUtils(ApplicationContextModule_ProvideContextFactory.provideContext(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.applicationContextModule));
      }
      ...
      private SessionDetailViewModel_AssistedFactory getSessionDetailViewModel_AssistedFactory() {
        return SessionDetailViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getLoadUserSessionsUseCaseProvider(), getStarEventAndNotifyUseCaseProvider(), getReservationActionUseCaseProvider(), getGetTimeZoneUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManagerProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTimeProviderProvider(), getNetworkUtilsProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getReservationEnabledFlagBooleanProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getDefaultDispatcherCoroutineDispatcherProvider());
      }
      ...
      private FeedbackUseCase getFeedbackUseCase() {
        return new FeedbackUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getFeedbackEndpoint(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SessionFeedbackViewModel_AssistedFactory getSessionFeedbackViewModel_AssistedFactory(
        ...
        return SessionFeedbackViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getLoadUserSessionUseCaseProvider(), getFeedbackUseCaseProvider());
      }
      ...
      private SetTimeZoneUseCase getSetTimeZoneUseCase() {
        return new SetTimeZoneUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private NotificationsPrefSaveActionUseCase getNotificationsPrefSaveActionUseCase() {
        return new NotificationsPrefSaveActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetNotificationsSettingUseCase getGetNotificationsSettingUseCase() {
        return new GetNotificationsSettingUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetAnalyticsSettingUseCase getSetAnalyticsSettingUseCase() {
        return new SetAnalyticsSettingUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetAnalyticsSettingUseCase getGetAnalyticsSettingUseCase() {
        return new GetAnalyticsSettingUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private SetThemeUseCase getSetThemeUseCase() {
        return new SetThemeUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private GetAvailableThemesUseCase getGetAvailableThemesUseCase() {
        return new GetAvailableThemesUseCase(TestCoroutinesModule_ProvidesMainImmediateDispatcherFactory.providesMainImmediateDispatcher());
      }
      ...
      private SignInViewModel_AssistedFactory getSignInViewModel_AssistedFactory() {
        return SignInViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider());
      }
      ...
      private StopSnackbarActionUseCase getStopSnackbarActionUseCase() {
        return new StopSnackbarActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private LoadSpeakerUseCase getLoadSpeakerUseCase() {
        return new LoadSpeakerUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getConferenceDataRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
      }
      ...
      private EventActionsViewModelDelegate getEventActionsViewModelDelegate() {
        return EventActionsViewModelDelegateModule_ProvideEventActionsViewModelDelegateFactory.provideEventActionsViewModelDelegate(eventActionsViewModelDelegateModule, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegate(), getStarEventAndNotifyUseCase(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getApplicationScopeCoroutineScope(), TestCoroutinesModule_ProvidesMainDispatcherFactory.providesMainDispatcher());
      }
      ...
      private SpeakerViewModel_AssistedFactory getSpeakerViewModel_AssistedFactory() {
        return SpeakerViewModel_AssistedFactory_Factory.newInstance(getLoadSpeakerUseCaseProvider(), getLoadUserSessionsUseCaseProvider(), getGetTimeZoneUseCaseProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegateProvider(), getEventActionsViewModelDelegateProvider(), DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelperProvider());
      }
      ...
      private ThemeViewModel_AssistedFactory getThemeViewModel_AssistedFactory() {
        return ThemeViewModel_AssistedFactory_Factory.newInstance(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getThemedActivityDelegateProvider());
      }
      ...
      private ViewModelProvider.Factory getProvideFactory() {
        return ViewModelFactoryModules_ActivityModule_ProvideFactoryFactory.provideFactory(activity, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.applicationContextModule), getMapOfStringAndProviderOfViewModelAssistedFactoryOf());
      }
      ...
      @Override
      public void injectSessionDetailActivity(SessionDetailActivity arg0) {
        injectSessionDetailActivity2(arg0);
      }
      ...
      private MainActivity injectMainActivity2(MainActivity instance) {
        MainActivity_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
        MainActivity_MembersInjector.injectConnectivityManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getConnectivityManager());
        MainActivity_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
        MainActivity_MembersInjector.injectMapFeatureEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
        MainActivity_MembersInjector.injectCodelabsFeatureEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getCodelabsEnabledFlagBoolean());
        MainActivity_MembersInjector.injectExploreArFeatureEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getExploreArEnabledFlagBoolean());
        return instance;
      }

      @CanIgnoreReturnValue
      private SessionDetailActivity injectSessionDetailActivity2(SessionDetailActivity instance) {
        SessionDetailActivity_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
        return instance;
      }

      private final class FragmentCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.FragmentC.Builder {
        ...
        @Override
        public ScheduleTestSensorConditionsTest_HiltComponents.FragmentC build() {
          Preconditions.checkBuilderRequirement(fragment, Fragment.class);
          return new FragmentCImpl(new SessionViewPoolModule(), fragment);
        }
      }

      private final class FragmentCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.FragmentC {
        ...
        private SwapActionUseCase getSwapActionUseCase() {
          return new SwapActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSessionAndUserEventRepository(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private MarkScheduleUiHintsShownUseCase getMarkScheduleUiHintsShownUseCase() {
          return new MarkScheduleUiHintsShownUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private NotificationsPrefShownActionUseCase getNotificationsPrefShownActionUseCase() {
          return new NotificationsPrefShownActionUseCase(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.preferenceStorage(), TestCoroutinesModule_ProvidesIoDispatcherFactory.providesIoDispatcher());
        }

        private ViewModelProvider.Factory getProvideFactory() {
          return ViewModelFactoryModules_FragmentModule_ProvideFactoryFactory.provideFactory(fragment, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.applicationContextModule), ActivityCImpl.this.getMapOfStringAndProviderOfViewModelAssistedFactoryOf());
        }

        @Override
        public void injectAgendaFragment(AgendaFragment arg0) {
        }

        @Override
        public void injectCodelabsFragment(CodelabsFragment arg0) {
          injectCodelabsFragment2(arg0);
        }

        @Override
        public void injectAnnouncementsFragment(AnnouncementsFragment arg0) {
          injectAnnouncementsFragment2(arg0);
        }

        @Override
        public void injectFeedFragment(FeedFragment arg0) {
          injectFeedFragment2(arg0);
        }

        @Override
        public void injectEventFragment(EventFragment arg0) {
          injectEventFragment2(arg0);
        }

        @Override
        public void injectFaqFragment(FaqFragment arg0) {
        }

        @Override
        public void injectInfoFragment(InfoFragment arg0) {
          injectInfoFragment2(arg0);
        }

        @Override
        public void injectTravelFragment(TravelFragment arg0) {
        }

        @Override
        public void injectMapFragment(MapFragment arg0) {
          injectMapFragment2(arg0);
        }
        ...
        @Override
        public void injectOnboardingSignInFragment(OnboardingSignInFragment arg0) {
        }

        @Override
        public void injectWelcomeDuringConferenceFragment(WelcomeDuringConferenceFragment arg0) {
        }

        @Override
        public void injectWelcomePreConferenceFragment(WelcomePreConferenceFragment arg0) {
        }

        @Override
        public void injectRemoveReservationDialogFragment(RemoveReservationDialogFragment arg0) {
        }

        @Override
        public void injectSwapReservationDialogFragment(SwapReservationDialogFragment arg0) {
          injectSwapReservationDialogFragment2(arg0);
        }

        @Override
        public void injectScheduleFragment(ScheduleFragment arg0) {
          injectScheduleFragment2(arg0);
        }

        @Override
        public void injectScheduleUiHintsDialogFragment(ScheduleUiHintsDialogFragment arg0) {
          injectScheduleUiHintsDialogFragment2(arg0);
        }
        ...
        @Override
        public void injectSessionDetailFragment(SessionDetailFragment arg0) {
          injectSessionDetailFragment2(arg0);
        }

        @Override
        public void injectSessionFeedbackFragment(SessionFeedbackFragment arg0) {
        }
        ...
        @Override
        public void injectThemeSettingDialogFragment(ThemeSettingDialogFragment arg0) {
        }

        @Override
        public void injectNotificationsPreferenceDialogFragment(
            NotificationsPreferenceDialogFragment arg0) {
          injectNotificationsPreferenceDialogFragment2(arg0);
        }

        @Override
        public void injectSignInDialogFragment(SignInDialogFragment arg0) {
          injectSignInDialogFragment2(arg0);
        }

        @Override
        public void injectSignOutDialogFragment(SignOutDialogFragment arg0) {
          injectSignOutDialogFragment2(arg0);
        }

        @Override
        public void injectSpeakerFragment(SpeakerFragment arg0) {
          injectSpeakerFragment2(arg0);
        }
        ...
        private CodelabsFragment injectCodelabsFragment2(CodelabsFragment instance) {
          ...
          CodelabsFragment_MembersInjector.injectMapFeatureEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
          CodelabsFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private AnnouncementsFragment injectAnnouncementsFragment2(AnnouncementsFragment instance) {
          AnnouncementsFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private FeedFragment injectFeedFragment2(FeedFragment instance) {
          FeedFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          FeedFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private EventFragment injectEventFragment2(EventFragment instance) {
          EventFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          EventFragment_MembersInjector.injectAssistantAppEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAssistantAppEnabledFlagBoolean());
          return instance;
        }

        @CanIgnoreReturnValue
        private InfoFragment injectInfoFragment2(InfoFragment instance) {
          InfoFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }

        @CanIgnoreReturnValue
        private MapFragment injectMapFragment2(MapFragment instance) {
          MapFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          return instance;
        }
        ...
        private ScheduleFragment injectScheduleFragment2(ScheduleFragment instance) {
          ScheduleFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          ScheduleFragment_MembersInjector.injectTagViewPool(instance, getNamedRecycledViewPool());
          ScheduleFragment_MembersInjector.injectSearchScheduleFeatureEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSearchScheduleEnabledFlagBoolean());
          ScheduleFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          return instance;
        }
        ...
        private SearchFragment injectSearchFragment2(SearchFragment instance) {
          SearchFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
        ...
        private SessionDetailFragment injectSessionDetailFragment2(SessionDetailFragment instance) {
          SessionDetailFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          SessionDetailFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          SessionDetailFragment_MembersInjector.injectTagRecycledViewPool(instance, getNamedRecycledViewPool());
          SessionDetailFragment_MembersInjector.injectIsMapEnabled(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getMapFeatureEnabledFlagBoolean());
          return instance;
        }
        ...
        private SignInDialogFragment injectSignInDialogFragment2(SignInDialogFragment instance) {
          SignInDialogFragment_MembersInjector.injectSignInHandler(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInHandler());
          return instance;
        }

        @CanIgnoreReturnValue
        private SignOutDialogFragment injectSignOutDialogFragment2(SignOutDialogFragment instance) {
          SignOutDialogFragment_MembersInjector.injectSignInHandler(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInHandler());
          return instance;
        }

        @CanIgnoreReturnValue
        private SpeakerFragment injectSpeakerFragment2(SpeakerFragment instance) {
          SpeakerFragment_MembersInjector.injectSnackbarMessageManager(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager());
          SpeakerFragment_MembersInjector.injectAnalyticsHelper(instance, DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper());
          SpeakerFragment_MembersInjector.injectTagRecycledViewPool(instance, getNamedRecycledViewPool());
          return instance;
        }

        private final class ViewWithFragmentCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.ViewWithFragmentC.Builder {
          private View view;
          ...
          @Override
          public ScheduleTestSensorConditionsTest_HiltComponents.ViewWithFragmentC build() {
            Preconditions.checkBuilderRequirement(view, View.class);
            return new ViewWithFragmentCImpl(view);
          }
        }

        private final class ViewWithFragmentCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.ViewWithFragmentC {
      ...
      private final class ViewCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.ViewC.Builder {
        private View view;
        ...
        @Override
        public ScheduleTestSensorConditionsTest_HiltComponents.ViewC build() {
          Preconditions.checkBuilderRequirement(view, View.class);
          return new ViewCImpl(view);
        }
      }

      private final class ViewCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.ViewC {
  ...
  private final class ServiceCBuilder implements ScheduleTestSensorConditionsTest_HiltComponents.ServiceC.Builder {
    ...
    @Override
    public ScheduleTestSensorConditionsTest_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(service);
    }
  }

  private final class ServiceCImpl extends ScheduleTestSensorConditionsTest_HiltComponents.ServiceC {
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTimeProvider();

        case 1: // com.google.samples.apps.iosched.shared.domain.logistics.LoadWifiInfoUseCase 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getLoadWifiInfoUseCase();

        case 2: // com.google.samples.apps.iosched.shared.analytics.AnalyticsHelper 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getAnalyticsHelper();

        case 3: // com.google.samples.apps.iosched.ui.signin.SignInViewModelDelegate 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSignInViewModelDelegate();

        case 4: // com.google.samples.apps.iosched.ui.theme.ThemedActivityDelegate 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getThemedActivityDelegate();

        case 5: // @dagger.hilt.android.qualifiers.ApplicationContext android.content.Context 
        return (T) ApplicationContextModule_ProvideContextFactory.provideContext(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.applicationContextModule);

        case 6: // com.google.samples.apps.iosched.shared.fcm.TopicSubscriber 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getTopicSubscriber();

        case 7: // com.google.samples.apps.iosched.ui.messages.SnackbarMessageManager 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getSnackbarMessageManager();

        case 8: // com.google.samples.apps.iosched.ui.filters.FiltersViewModelDelegate 
        return (T) FiltersViewModelDelegateModule_ProvideFiltersViewModelDelegateFactory.provideFiltersViewModelDelegate(DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.filtersViewModelDelegateModule);

        case 9: // @com.google.samples.apps.iosched.shared.di.ReservationEnabledFlag java.lang.Boolean 
        return (T) (Boolean) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getReservationEnabledFlagBoolean();

        case 10: // @com.google.samples.apps.iosched.shared.di.DefaultDispatcher kotlinx.coroutines.CoroutineDispatcher 
        return (T) TestCoroutinesModule_ProvidesDefaultDispatcherFactory.providesDefaultDispatcher();

        case 11: // com.google.samples.apps.iosched.shared.domain.settings.GetThemeUseCase 
        return (T) DaggerScheduleTestSensorConditionsTest_HiltComponents_ApplicationC.this.getGetThemeUseCase();
