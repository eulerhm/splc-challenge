...
public class ItemFilterChipCloseableBindingImpl extends ItemFilterChipCloseableBinding  {
    ...
    public ItemFilterChipCloseableBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 1, sIncludes, sViewsWithIds));
    }
    private ItemFilterChipCloseableBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.google.samples.apps.iosched.ui.filters.FiltersViewBindingAdaptersKt.filterChipOnClose(this.filterLabel, filterChip, viewModel);
        }
    }
