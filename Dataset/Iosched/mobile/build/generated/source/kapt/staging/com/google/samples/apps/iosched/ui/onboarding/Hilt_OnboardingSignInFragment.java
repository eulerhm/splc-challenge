...
public abstract class Hilt_OnboardingSignInFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_OnboardingSignInFragment() {
    super();
  }

  Hilt_OnboardingSignInFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((OnboardingSignInFragment_GeneratedInjector) generatedComponent()).injectOnboardingSignInFragment(UnsafeCasts.<OnboardingSignInFragment>unsafeCast(this));
  }
