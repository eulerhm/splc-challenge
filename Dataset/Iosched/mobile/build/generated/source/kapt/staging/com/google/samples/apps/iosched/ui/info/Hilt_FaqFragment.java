...
public abstract class Hilt_FaqFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_FaqFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((FaqFragment_GeneratedInjector) generatedComponent()).injectFaqFragment(UnsafeCasts.<FaqFragment>unsafeCast(this));
  }
