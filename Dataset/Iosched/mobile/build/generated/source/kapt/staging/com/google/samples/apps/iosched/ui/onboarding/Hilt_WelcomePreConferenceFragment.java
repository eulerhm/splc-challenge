...
public abstract class Hilt_WelcomePreConferenceFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_WelcomePreConferenceFragment() {
    super();
  }

  Hilt_WelcomePreConferenceFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((WelcomePreConferenceFragment_GeneratedInjector) generatedComponent()).injectWelcomePreConferenceFragment(UnsafeCasts.<WelcomePreConferenceFragment>unsafeCast(this));
  }
