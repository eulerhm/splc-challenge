...
public abstract class Hilt_MapFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((MapFragment_GeneratedInjector) generatedComponent()).injectMapFragment(UnsafeCasts.<MapFragment>unsafeCast(this));
  }
