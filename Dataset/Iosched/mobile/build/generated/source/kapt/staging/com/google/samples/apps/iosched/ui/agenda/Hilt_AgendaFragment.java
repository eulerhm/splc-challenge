...
public abstract class Hilt_AgendaFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((AgendaFragment_GeneratedInjector) generatedComponent()).injectAgendaFragment(UnsafeCasts.<AgendaFragment>unsafeCast(this));
  }
