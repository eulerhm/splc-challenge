...
public abstract class Hilt_WelcomeDuringConferenceFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_WelcomeDuringConferenceFragment() {
    super();
  }

  Hilt_WelcomeDuringConferenceFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((WelcomeDuringConferenceFragment_GeneratedInjector) generatedComponent()).injectWelcomeDuringConferenceFragment(UnsafeCasts.<WelcomeDuringConferenceFragment>unsafeCast(this));
  }
