...
public abstract class Hilt_OnboardingFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_OnboardingFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((OnboardingFragment_GeneratedInjector) generatedComponent()).injectOnboardingFragment(UnsafeCasts.<OnboardingFragment>unsafeCast(this));
  }
