...
public abstract class Hilt_CodelabsFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((CodelabsFragment_GeneratedInjector) generatedComponent()).injectCodelabsFragment(UnsafeCasts.<CodelabsFragment>unsafeCast(this));
  }
