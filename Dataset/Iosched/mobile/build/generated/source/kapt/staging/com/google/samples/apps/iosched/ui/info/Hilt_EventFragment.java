...
public abstract class Hilt_EventFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_EventFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((EventFragment_GeneratedInjector) generatedComponent()).injectEventFragment(UnsafeCasts.<EventFragment>unsafeCast(this));
  }
