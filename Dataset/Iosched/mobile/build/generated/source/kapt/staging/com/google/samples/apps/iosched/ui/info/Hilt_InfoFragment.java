...
public abstract class Hilt_InfoFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((InfoFragment_GeneratedInjector) generatedComponent()).injectInfoFragment(UnsafeCasts.<InfoFragment>unsafeCast(this));
  }
