...
public abstract class Hilt_TravelFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_TravelFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((TravelFragment_GeneratedInjector) generatedComponent()).injectTravelFragment(UnsafeCasts.<TravelFragment>unsafeCast(this));
  }
