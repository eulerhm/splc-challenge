...
public abstract class Hilt_FeedFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((FeedFragment_GeneratedInjector) generatedComponent()).injectFeedFragment(UnsafeCasts.<FeedFragment>unsafeCast(this));
  }
