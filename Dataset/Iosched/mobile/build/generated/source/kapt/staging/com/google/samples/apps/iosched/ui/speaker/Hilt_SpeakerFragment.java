...
public abstract class Hilt_SpeakerFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((SpeakerFragment_GeneratedInjector) generatedComponent()).injectSpeakerFragment(UnsafeCasts.<SpeakerFragment>unsafeCast(this));
  }
