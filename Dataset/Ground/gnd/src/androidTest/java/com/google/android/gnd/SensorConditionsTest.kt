    ...
    companion object {
        ...
        private fun changeSpecificSensor(
            ...
            try {
                ...
                if (sensorName.equals("Gyroscope", ignoreCase = true) ||
                    sensorName.equals("Light", ignoreCase = true) ||
                    sensorName.equals("Magnetic Field", ignoreCase = true) ||
                    sensorName.equals("Orientation", ignoreCase = true) ||
