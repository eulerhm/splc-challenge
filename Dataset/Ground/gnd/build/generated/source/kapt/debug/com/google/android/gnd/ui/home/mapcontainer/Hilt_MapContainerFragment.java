...
abstract class Hilt_MapContainerFragment extends AbstractMapViewerFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapContainerFragment_GeneratedInjector) this.generatedComponent()).injectMapContainerFragment(UnsafeCasts.<MapContainerFragment>unsafeCast(this));
    }
  }
