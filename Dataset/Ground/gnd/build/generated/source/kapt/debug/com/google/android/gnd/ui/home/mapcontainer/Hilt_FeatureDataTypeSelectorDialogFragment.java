...
abstract class Hilt_FeatureDataTypeSelectorDialogFragment extends AbstractDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeatureDataTypeSelectorDialogFragment_GeneratedInjector) this.generatedComponent()).injectFeatureDataTypeSelectorDialogFragment(UnsafeCasts.<FeatureDataTypeSelectorDialogFragment>unsafeCast(this));
    }
  }
