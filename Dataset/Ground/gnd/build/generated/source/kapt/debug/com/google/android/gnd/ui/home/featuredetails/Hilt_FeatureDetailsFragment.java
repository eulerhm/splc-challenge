...
abstract class Hilt_FeatureDetailsFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeatureDetailsFragment_GeneratedInjector) this.generatedComponent()).injectFeatureDetailsFragment(UnsafeCasts.<FeatureDetailsFragment>unsafeCast(this));
    }
  }
