...
abstract class Hilt_HomeScreenFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeScreenFragment_GeneratedInjector) this.generatedComponent()).injectHomeScreenFragment(UnsafeCasts.<HomeScreenFragment>unsafeCast(this));
    }
  }
