...
abstract class Hilt_OfflineAreaSelectorFragment extends AbstractMapViewerFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OfflineAreaSelectorFragment_GeneratedInjector) this.generatedComponent()).injectOfflineAreaSelectorFragment(UnsafeCasts.<OfflineAreaSelectorFragment>unsafeCast(this));
    }
  }
