...
public class DateInputFieldBindingImpl extends DateInputFieldBinding implements com.google.android.gnd.generated.callback.OnClickListener.Listener {
    ...
    public DateInputFieldBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private DateInputFieldBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback10 = new com.google.android.gnd.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.google.android.gnd.ui.editsubmission.DateFieldViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.google.android.gnd.ui.editsubmission.DateFieldViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.google.android.gnd.ui.editsubmission.DateFieldViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.textInputEditText.setOnClickListener(mCallback10);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1
