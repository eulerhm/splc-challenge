...
public abstract class Hilt_DataCollectionFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DataCollectionFragment_GeneratedInjector) this.generatedComponent()).injectDataCollectionFragment(UnsafeCasts.<DataCollectionFragment>unsafeCast(this));
    }
  }
