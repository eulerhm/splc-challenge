...
abstract class Hilt_GoogleMapsFragment extends SupportMapFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GoogleMapsFragment_GeneratedInjector) this.generatedComponent()).injectGoogleMapsFragment(UnsafeCasts.<GoogleMapsFragment>unsafeCast(this));
    }
  }
