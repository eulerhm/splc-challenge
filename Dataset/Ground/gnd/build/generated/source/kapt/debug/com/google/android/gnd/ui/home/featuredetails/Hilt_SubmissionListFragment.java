...
abstract class Hilt_SubmissionListFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubmissionListFragment_GeneratedInjector) this.generatedComponent()).injectSubmissionListFragment(UnsafeCasts.<SubmissionListFragment>unsafeCast(this));
    }
  }
