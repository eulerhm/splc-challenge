...
abstract class Hilt_SubmissionDetailsFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubmissionDetailsFragment_GeneratedInjector) this.generatedComponent()).injectSubmissionDetailsFragment(UnsafeCasts.<SubmissionDetailsFragment>unsafeCast(this));
    }
  }
