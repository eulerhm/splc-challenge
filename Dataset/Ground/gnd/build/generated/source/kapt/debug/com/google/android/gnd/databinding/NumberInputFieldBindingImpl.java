...
public class NumberInputFieldBindingImpl extends NumberInputFieldBinding implements com.google.android.gnd.generated.callback.Consumer.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.number_input_layout, 3);
    }
    // views
    @NonNull
    ...
    // variables
    @Nullable
    private final java8.util.function.Consumer mCallback22;
    // values
    // listeners
    // Inverse Binding Event Handlers

    public NumberInputFieldBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private NumberInputFieldBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.numberInputEditText.setTag(null);
        setRootTag(root);
        // listeners
        mCallback22 = new com.google.android.gnd.generated.callback.Consumer(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.google.android.gnd.ui.editsubmission.NumberFieldViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.google.android.gnd.ui.editsubmission.NumberFieldViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.google.android.gnd.ui.editsubmission.NumberFieldViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.numberInputEditText, viewModelResponseTextGetValue);
        }
        if ((dirtyFlags & 0xeL) != 0) {
            // api target 1

            this.numberInputEditText.setError(viewModelErrorGetValue);
        }
        if ((dirtyFlags & 0x8L) != 0) {
            // api target 1

            com.google.android.gnd.ui.common.BindingAdapters.bindTextWatcher(this.numberInputEditText, mCallback22);
        }
    }
    // Listener Stub Implementations
    // callback impls
    public final void _internalCallbackAccept(int sourceId , java.lang.Object callbackArg_0) {
        ...
        if (viewModelJavaLangObjectNull) {
            ...
            viewModel.updateResponse(((java.lang.String) (callbackArg_0)));
        }
    }
    // dirty flag
