...
abstract class Hilt_EditSubmissionFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditSubmissionFragment_GeneratedInjector) this.generatedComponent()).injectEditSubmissionFragment(UnsafeCasts.<EditSubmissionFragment>unsafeCast(this));
    }
  }
