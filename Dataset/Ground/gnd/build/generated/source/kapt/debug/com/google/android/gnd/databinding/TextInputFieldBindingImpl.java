...
public class TextInputFieldBindingImpl extends TextInputFieldBinding implements com.google.android.gnd.generated.callback.Consumer.Listener {
    ...
    // variables
    @Nullable
    private final java8.util.function.Consumer mCallback21;
    // values
    // listeners
    // Inverse Binding Event Handlers

    public TextInputFieldBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private TextInputFieldBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback21 = new com.google.android.gnd.generated.callback.Consumer(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.google.android.gnd.ui.editsubmission.TextFieldViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.google.android.gnd.ui.editsubmission.TextFieldViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.google.android.gnd.ui.editsubmission.TextFieldViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            com.google.android.gnd.ui.common.BindingAdapters.bindTextWatcher(this.textInputEditText, mCallback21);
        }
    }
