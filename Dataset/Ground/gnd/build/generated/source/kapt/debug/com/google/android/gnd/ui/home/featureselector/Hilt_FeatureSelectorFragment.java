...
abstract class Hilt_FeatureSelectorFragment extends AbstractDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeatureSelectorFragment_GeneratedInjector) this.generatedComponent()).injectFeatureSelectorFragment(UnsafeCasts.<FeatureSelectorFragment>unsafeCast(this));
    }
  }
