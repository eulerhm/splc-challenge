...
abstract class Hilt_SyncStatusFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SyncStatusFragment_GeneratedInjector) this.generatedComponent()).injectSyncStatusFragment(UnsafeCasts.<SyncStatusFragment>unsafeCast(this));
    }
  }
