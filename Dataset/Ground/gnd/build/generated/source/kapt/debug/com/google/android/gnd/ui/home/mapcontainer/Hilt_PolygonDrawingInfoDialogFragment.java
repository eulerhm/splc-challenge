...
abstract class Hilt_PolygonDrawingInfoDialogFragment extends AbstractDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PolygonDrawingInfoDialogFragment_GeneratedInjector) this.generatedComponent()).injectPolygonDrawingInfoDialogFragment(UnsafeCasts.<PolygonDrawingInfoDialogFragment>unsafeCast(this));
    }
  }
