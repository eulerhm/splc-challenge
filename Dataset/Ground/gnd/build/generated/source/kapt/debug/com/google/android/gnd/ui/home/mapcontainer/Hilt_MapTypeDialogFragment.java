...
public abstract class Hilt_MapTypeDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapTypeDialogFragment_GeneratedInjector) this.generatedComponent()).injectMapTypeDialogFragment(UnsafeCasts.<MapTypeDialogFragment>unsafeCast(this));
    }
  }
