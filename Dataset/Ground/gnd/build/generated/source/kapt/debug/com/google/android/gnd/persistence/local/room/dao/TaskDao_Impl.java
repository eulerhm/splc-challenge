...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntity = new EntityInsertionAdapter<TaskEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `task` (`id`,`title`,`job_id`) VALUES (?,?,?)";
      }
    ...
    this.__updateAdapterOfTaskEntity = new EntityDeletionOrUpdateAdapter<TaskEntity>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `task` SET `id` = ?,`title` = ?,`job_id` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Completable insert(final TaskEntity entity) {
    return Completable.fromCallable(new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfTaskEntity.insert(entity);
  ...
  @Override
  public Completable delete(final TaskEntity entity) {
    return Completable.fromCallable(new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfTaskEntity.handle(entity);
          __db.setTransactionSuccessful();
          return null;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Single<Integer> update(final TaskEntity entity) {
    return Single.fromCallable(new Callable<Integer>() {
      ...
      public Integer call() throws Exception {
        ...
        __db.beginTransaction();
        try {
          _total +=__updateAdapterOfTaskEntity.handle(entity);
          __db.setTransactionSuccessful();
          return _total;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Completable updateAll(final List<TaskEntity> entities) {
    return Completable.fromCallable(new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfTaskEntity.handleMultiple(entities);
          __db.setTransactionSuccessful();
          return null;
        } finally {
          __db.endTransaction();
