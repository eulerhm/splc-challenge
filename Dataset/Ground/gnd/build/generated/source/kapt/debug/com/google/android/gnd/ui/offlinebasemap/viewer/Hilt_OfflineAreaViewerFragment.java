...
abstract class Hilt_OfflineAreaViewerFragment extends AbstractMapViewerFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OfflineAreaViewerFragment_GeneratedInjector) this.generatedComponent()).injectOfflineAreaViewerFragment(UnsafeCasts.<OfflineAreaViewerFragment>unsafeCast(this));
    }
  }
