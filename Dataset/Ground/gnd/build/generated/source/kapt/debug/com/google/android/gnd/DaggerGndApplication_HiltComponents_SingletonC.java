...
import com.google.android.gnd.persistence.local.LocalDatabaseModule_LocalDatabaseFactory;
...
import com.google.android.gnd.persistence.remote.RemoteStorageModule_FirebaseFirestoreFactory;
import com.google.android.gnd.persistence.remote.RemoteStorageModule_FirebaseFirestoreSettingsFactory;
import com.google.android.gnd.persistence.remote.RemoteStorageModule_FirebaseStorageReferenceFactory;
import com.google.android.gnd.persistence.remote.firestore.FirestoreDataStore;
import com.google.android.gnd.persistence.remote.firestore.FirestoreDataStore_Factory;
import com.google.android.gnd.persistence.remote.firestore.FirestoreDataStore_MembersInjector;
import com.google.android.gnd.persistence.remote.firestore.FirestoreStorageManager;
import com.google.android.gnd.persistence.remote.firestore.FirestoreStorageManager_Factory;
import com.google.android.gnd.persistence.remote.firestore.FirestoreStorageManager_MembersInjector;
import com.google.android.gnd.persistence.remote.firestore.FirestoreUuidGenerator;
import com.google.android.gnd.persistence.remote.firestore.FirestoreUuidGenerator_Factory;
import com.google.android.gnd.persistence.remote.firestore.schema.GroundFirestore;
import com.google.android.gnd.persistence.remote.firestore.schema.GroundFirestore_Factory;
...
import com.google.android.gnd.persistence.sync.WorkManagerModule_ProvideWorkManagerFactory;
...
import com.google.android.gnd.rx.RxSchedulers_Factory;
...
public final class DaggerGndApplication_HiltComponents_SingletonC extends GndApplication_HiltComponents.SingletonC {
  private final ApplicationContextModule applicationContextModule;

  private final DaggerGndApplication_HiltComponents_SingletonC singletonC = this;
  ...
  private Provider<GroundFirestore> groundFirestoreProvider;

  private Provider<FirestoreDataStore> firestoreDataStoreProvider;
  ...
  private Provider<StorageReference> firebaseStorageReferenceProvider;

  private Provider<FirestoreStorageManager> firestoreStorageManagerProvider;

  private Provider<FirestoreUuidGenerator> firestoreUuidGeneratorProvider;
  ...
  private Provider<GoogleAuthenticationManager> googleAuthenticationManagerProvider;

  private Provider<AuthenticationManager> googleAuthenticationManagerProvider2;
  ...
  private DaggerGndApplication_HiltComponents_SingletonC(
  ...
  private LocalDatabase localDatabase() {
    return LocalDatabaseModule_LocalDatabaseFactory.localDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  }
  ...
  private FirebaseFirestore firebaseFirestore() {
    return RemoteStorageModule_FirebaseFirestoreFactory.firebaseFirestore(RemoteStorageModule_FirebaseFirestoreSettingsFactory.firebaseFirestoreSettings());
  }

  private GroundFirestore groundFirestore() {
    return GroundFirestore_Factory.newInstance(firebaseFirestoreProvider.get());
  }

  private FirestoreDataStore firestoreDataStore() {
    return injectFirestoreDataStore(FirestoreDataStore_Factory.newInstance());
  }
  ...
  private WorkManager workManager() {
    return WorkManagerModule_ProvideWorkManagerFactory.provideWorkManager(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  }
  ...
  private FirestoreStorageManager firestoreStorageManager() {
    return injectFirestoreStorageManager(FirestoreStorageManager_Factory.newInstance());
  }

  private UserMediaRepository userMediaRepository() {
    return new UserMediaRepository(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule), firestoreStorageManagerProvider.get(), offlineUuidGeneratorProvider.get());
  }
  ...
  private LocalMutationSyncWorker localMutationSyncWorker(Context context,
    ...
    return new LocalMutationSyncWorker(context, params, roomLocalDataStoreProvider.get(), firestoreDataStoreProvider.get(), notificationManagerProvider.get(), photoSyncWorkManager());
  }
  ...
  private PhotoSyncWorker photoSyncWorker(Context context2, WorkerParameters workerParams) {
    return new PhotoSyncWorker(context2, workerParams, firestoreStorageManagerProvider.get(), notificationManagerProvider.get());
  }
  ...
  private GoogleAuthenticationManager googleAuthenticationManager() {
    return new GoogleAuthenticationManager(resources(), activityStreamsProvider.get());
  }

  private UserRepository userRepository() {
    return new UserRepository(googleAuthenticationManagerProvider2.get(), roomLocalDataStoreProvider.get(), localValueStoreProvider.get(), schedulersProvider.get());
  }

  private SurveyRepository surveyRepository() {
    return new SurveyRepository(userRepository(), roomLocalDataStoreProvider.get(), firestoreDataStoreProvider.get(), localValueStoreProvider.get());
  }
  ...
  private FeatureRepository featureRepository() {
    return new FeatureRepository(roomLocalDataStoreProvider.get(), localValueStoreProvider.get(), firestoreDataStoreProvider.get(), surveyRepositoryProvider.get(), dataSyncWorkManager(), googleAuthenticationManagerProvider2.get(), offlineUuidGeneratorProvider.get());
  }
  ...
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    ...
    this.rxSchedulersProvider = new SwitchingProvider<>(singletonC, 3);
    this.schedulersProvider = DoubleCheck.provider((Provider) rxSchedulersProvider);
    this.roomLocalDataStoreProvider = DoubleCheck.provider(new SwitchingProvider<RoomLocalDataStore>(singletonC, 1));
    this.applicationErrorManagerProvider = DoubleCheck.provider(new SwitchingProvider<ApplicationErrorManager>(singletonC, 5));
    this.firebaseFirestoreProvider = DoubleCheck.provider(new SwitchingProvider<FirebaseFirestore>(singletonC, 7));
    this.groundFirestoreProvider = DoubleCheck.provider(new SwitchingProvider<GroundFirestore>(singletonC, 6));
    this.firestoreDataStoreProvider = DoubleCheck.provider(new SwitchingProvider<FirestoreDataStore>(singletonC, 4));
    this.notificationManagerProvider = DoubleCheck.provider(new SwitchingProvider<NotificationManager>(singletonC, 8));
    this.provideWorkManagerProvider = DoubleCheck.provider(new SwitchingProvider<WorkManager>(singletonC, 9));
    this.provideSharedPreferencesProvider = DoubleCheck.provider(new SwitchingProvider<SharedPreferences>(singletonC, 11));
    this.localValueStoreProvider = DoubleCheck.provider(new SwitchingProvider<LocalValueStore>(singletonC, 10));
    this.firebaseStorageReferenceProvider = DoubleCheck.provider(new SwitchingProvider<StorageReference>(singletonC, 14));
    this.firestoreStorageManagerProvider = DoubleCheck.provider(new SwitchingProvider<FirestoreStorageManager>(singletonC, 13));
    this.firestoreUuidGeneratorProvider = new SwitchingProvider<>(singletonC, 15);
    this.offlineUuidGeneratorProvider = DoubleCheck.provider((Provider) firestoreUuidGeneratorProvider);
    this.userMediaRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<UserMediaRepository>(singletonC, 12));
    this.localMutationSyncWorker_AssistedFactoryProvider = new SwitchingProvider<>(singletonC, 0);
    this.photoSyncWorker_AssistedFactoryProvider = new SwitchingProvider<>(singletonC, 16);
    this.tileSetDownloadWorker_AssistedFactoryProvider = new SwitchingProvider<>(singletonC, 17);
    this.activityStreamsProvider = DoubleCheck.provider(new SwitchingProvider<ActivityStreams>(singletonC, 18));
    this.permissionsManagerProvider = DoubleCheck.provider(new SwitchingProvider<PermissionsManager>(singletonC, 20));
    this.settingsManagerProvider = DoubleCheck.provider(new SwitchingProvider<SettingsManager>(singletonC, 21));
    this.locationManagerProvider = DoubleCheck.provider(new SwitchingProvider<LocationManager>(singletonC, 19));
    this.googleAuthenticationManagerProvider = new SwitchingProvider<>(singletonC, 22);
    this.googleAuthenticationManagerProvider2 = DoubleCheck.provider((Provider) googleAuthenticationManagerProvider);
    this.surveyRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SurveyRepository>(singletonC, 23));
    this.featureRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<FeatureRepository>(singletonC, 24));
    this.provideGeocoderProvider = DoubleCheck.provider(new SwitchingProvider<Geocoder>(singletonC, 26));
    this.geocodingManagerProvider = DoubleCheck.provider(new SwitchingProvider<GeocodingManager>(singletonC, 25));
    this.navigatorProvider = DoubleCheck.provider(new SwitchingProvider<Navigator>(singletonC, 27));
    this.ephemeralPopupsProvider = DoubleCheck.provider(new SwitchingProvider<EphemeralPopups>(singletonC, 28));
    this.markerIconFactoryProvider = DoubleCheck.provider(new SwitchingProvider<MarkerIconFactory>(singletonC, 29));
    this.mapsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MapsRepository>(singletonC, 30));
    this.googleApiAvailabilityProvider = DoubleCheck.provider(new SwitchingProvider<GoogleApiAvailability>(singletonC, 31));
  }
  ...
  @CanIgnoreReturnValue
  private FirestoreDataStore injectFirestoreDataStore(FirestoreDataStore instance) {
    FirestoreDataStore_MembersInjector.injectErrorManager(instance, applicationErrorManagerProvider.get());
    FirestoreDataStore_MembersInjector.injectDb(instance, groundFirestoreProvider.get());
    FirestoreDataStore_MembersInjector.injectSchedulers(instance, schedulersProvider.get());
    return instance;
  }

  @CanIgnoreReturnValue
  private FirestoreStorageManager injectFirestoreStorageManager(FirestoreStorageManager instance) {
    FirestoreStorageManager_MembersInjector.injectStorageReference(instance, firebaseStorageReferenceProvider.get());
    return instance;
  }
  ...
  public static final class Builder {
    ...
    public GndApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new DaggerGndApplication_HiltComponents_SingletonC(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements GndApplication_HiltComponents.ActivityRetainedC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;

    private ActivityRetainedCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC) {
      this.singletonC = singletonC;
    }

    @Override
    public GndApplication_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl(singletonC);
    }
  }

  private static final class ActivityCBuilder implements GndApplication_HiltComponents.ActivityC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ActivityCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC,
    ...
    @Override
    public GndApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonC, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements GndApplication_HiltComponents.FragmentC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private FragmentCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC,
    ...
    @Override
    public GndApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonC, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements GndApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewWithFragmentCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC,
        ActivityRetainedCImpl activityRetainedCImpl, ActivityCImpl activityCImpl,
    ...
    @Override
    public GndApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonC, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements GndApplication_HiltComponents.ViewC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC,
        ActivityRetainedCImpl activityRetainedCImpl, ActivityCImpl activityCImpl) {
      this.singletonC = singletonC;
      this.activityRetainedCImpl = activityRetainedCImpl;
      this.activityCImpl = activityCImpl;
    ...
    @Override
    public GndApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonC, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements GndApplication_HiltComponents.ViewModelC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewModelCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC,
        ActivityRetainedCImpl activityRetainedCImpl) {
      this.singletonC = singletonC;
      this.activityRetainedCImpl = activityRetainedCImpl;
    }
    ...
    @Override
    public GndApplication_HiltComponents.ViewModelC build() {
      Preconditions.checkBuilderRequirement(savedStateHandle, SavedStateHandle.class);
      return new ViewModelCImpl(singletonC, activityRetainedCImpl, savedStateHandle);
    }
  }

  private static final class ServiceCBuilder implements GndApplication_HiltComponents.ServiceC.Builder {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;

    private Service service;

    private ServiceCBuilder(DaggerGndApplication_HiltComponents_SingletonC singletonC) {
      this.singletonC = singletonC;
    }
    ...
    @Override
    public GndApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonC, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends GndApplication_HiltComponents.ViewWithFragmentC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewWithFragmentCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
        ActivityRetainedCImpl activityRetainedCImpl, ActivityCImpl activityCImpl,
  ...
  private static final class FragmentCImpl extends GndApplication_HiltComponents.FragmentC {
    ...
    private FragmentCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
        ActivityRetainedCImpl activityRetainedCImpl, ActivityCImpl activityCImpl,
    ...
    private HomeScreenFragment injectHomeScreenFragment2(HomeScreenFragment instance) {
      AbstractFragment_MembersInjector.injectViewModelFactory(instance, activityCImpl.viewModelFactory());
      HomeScreenFragment_MembersInjector.injectAuthenticationManager(instance, singletonC.googleAuthenticationManagerProvider2.get());
    ...
    private StartupFragment injectStartupFragment2(StartupFragment instance) {
      ...
      StartupFragment_MembersInjector.injectAuthenticationManager(instance, singletonC.googleAuthenticationManagerProvider2.get());
  ...
  private static final class ViewCImpl extends GndApplication_HiltComponents.ViewC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
  ...
  private static final class ActivityCImpl extends GndApplication_HiltComponents.ActivityC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ActivityCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
    ...
    private PolygonDrawingViewModel polygonDrawingViewModel() {
      return new PolygonDrawingViewModel(singletonC.locationManagerProvider.get(), singletonC.googleAuthenticationManagerProvider2.get(), singletonC.offlineUuidGeneratorProvider.get());
    }
    ...
    private TermsOfServiceRepository termsOfServiceRepository() {
      return new TermsOfServiceRepository(singletonC.firestoreDataStoreProvider.get(), singletonC.localValueStoreProvider.get());
    }

    private MainViewModel mainViewModel() {
      return new MainViewModel(singletonC.surveyRepositoryProvider.get(), singletonC.featureRepositoryProvider.get(), singletonC.userRepository(), termsOfServiceRepository(), singletonC.ephemeralPopupsProvider.get(), singletonC.navigatorProvider.get(), singletonC.googleAuthenticationManagerProvider2.get(), singletonC.schedulersProvider.get());
    }

    private SignInViewModel signInViewModel() {
      return SignInViewModel_Factory.newInstance(singletonC.googleAuthenticationManagerProvider2.get());
    }
    ...
    private SubmissionRepository submissionRepository() {
      return new SubmissionRepository(singletonC.roomLocalDataStoreProvider.get(), singletonC.firestoreDataStoreProvider.get(), singletonC.featureRepositoryProvider.get(), singletonC.dataSyncWorkManager(), singletonC.offlineUuidGeneratorProvider.get(), singletonC.googleAuthenticationManagerProvider2.get());
    }
    ...
    private SurveySelectorViewModel surveySelectorViewModel() {
      return SurveySelectorViewModel_Factory.newInstance(singletonC.surveyRepositoryProvider.get(), singletonC.googleAuthenticationManagerProvider2.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      SwitchingProvider(DaggerGndApplication_HiltComponents_SingletonC singletonC,
  ...
  private static final class ViewModelCImpl extends GndApplication_HiltComponents.ViewModelC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ViewModelCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
  ...
  private static final class ActivityRetainedCImpl extends GndApplication_HiltComponents.ActivityRetainedC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;
    ...
    private ActivityRetainedCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC) {
      this.singletonC = singletonC;
  ...
  private static final class ServiceCImpl extends GndApplication_HiltComponents.ServiceC {
    private final DaggerGndApplication_HiltComponents_SingletonC singletonC;

    private final ServiceCImpl serviceCImpl = this;

    private ServiceCImpl(DaggerGndApplication_HiltComponents_SingletonC singletonC,
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    SwitchingProvider(DaggerGndApplication_HiltComponents_SingletonC singletonC, int id) {
      this.singletonC = singletonC;
      this.id = id;
    }
    ...
    public T get() {
      switch (id) {
        ...
        case 3: // com.google.android.gnd.rx.RxSchedulers 
        return (T) RxSchedulers_Factory.newInstance();

        case 4: // com.google.android.gnd.persistence.remote.firestore.FirestoreDataStore 
        return (T) singletonC.firestoreDataStore();

        case 5: // com.google.android.gnd.system.ApplicationErrorManager 
        return (T) singletonC.applicationErrorManager();

        case 6: // com.google.android.gnd.persistence.remote.firestore.schema.GroundFirestore 
        return (T) singletonC.groundFirestore();

        case 7: // com.google.firebase.firestore.FirebaseFirestore 
        return (T) singletonC.firebaseFirestore();

        case 8: // com.google.android.gnd.system.NotificationManager 
        return (T) singletonC.notificationManager();

        case 9: // androidx.work.WorkManager 
        return (T) singletonC.workManager();

        case 10: // com.google.android.gnd.persistence.local.LocalValueStore 
        return (T) singletonC.localValueStore();

        case 11: // android.content.SharedPreferences 
        return (T) singletonC.sharedPreferences();

        case 12: // com.google.android.gnd.repository.UserMediaRepository 
        return (T) singletonC.userMediaRepository();

        case 13: // com.google.android.gnd.persistence.remote.firestore.FirestoreStorageManager 
        return (T) singletonC.firestoreStorageManager();

        case 14: // com.google.firebase.storage.StorageReference 
        return (T) RemoteStorageModule_FirebaseStorageReferenceFactory.firebaseStorageReference();

        case 15: // com.google.android.gnd.persistence.remote.firestore.FirestoreUuidGenerator 
        return (T) FirestoreUuidGenerator_Factory.newInstance();

        case 16: // com.google.android.gnd.persistence.sync.PhotoSyncWorker_AssistedFactory 
        return (T) singletonC.photoSyncWorker_AssistedFactory();

        case 17: // com.google.android.gnd.persistence.sync.TileSetDownloadWorker_AssistedFactory 
        return (T) singletonC.tileSetDownloadWorker_AssistedFactory();

        case 18: // com.google.android.gnd.system.ActivityStreams 
        return (T) new ActivityStreams();

        case 19: // com.google.android.gnd.system.LocationManager 
        return (T) singletonC.locationManager();

        case 20: // com.google.android.gnd.system.PermissionsManager 
        return (T) singletonC.permissionsManager();

        case 21: // com.google.android.gnd.system.SettingsManager 
        return (T) singletonC.settingsManager();

        case 22: // com.google.android.gnd.system.auth.GoogleAuthenticationManager 
        return (T) singletonC.googleAuthenticationManager();

        case 23: // com.google.android.gnd.repository.SurveyRepository 
        return (T) singletonC.surveyRepository();

        case 24: // com.google.android.gnd.repository.FeatureRepository 
        return (T) singletonC.featureRepository();

        case 25: // com.google.android.gnd.system.GeocodingManager 
        return (T) singletonC.geocodingManager();

        case 26: // android.location.Geocoder 
        return (T) singletonC.geocoder();

        case 27: // com.google.android.gnd.ui.common.Navigator 
        return (T) new Navigator();

        case 28: // com.google.android.gnd.ui.common.EphemeralPopups 
        return (T) singletonC.ephemeralPopups();

        case 29: // com.google.android.gnd.ui.MarkerIconFactory 
        return (T) singletonC.markerIconFactory();

        case 30: // com.google.android.gnd.repository.MapsRepository 
        return (T) singletonC.mapsRepository();

        case 31: // com.google.android.gms.common.GoogleApiAvailability 
