...
abstract class Hilt_SurveySelectorDialogFragment extends AbstractDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SurveySelectorDialogFragment_GeneratedInjector) this.generatedComponent()).injectSurveySelectorDialogFragment(UnsafeCasts.<SurveySelectorDialogFragment>unsafeCast(this));
    }
  }
