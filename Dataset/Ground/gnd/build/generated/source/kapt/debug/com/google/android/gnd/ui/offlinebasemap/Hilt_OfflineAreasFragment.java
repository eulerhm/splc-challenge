...
abstract class Hilt_OfflineAreasFragment extends AbstractFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OfflineAreasFragment_GeneratedInjector) this.generatedComponent()).injectOfflineAreasFragment(UnsafeCasts.<OfflineAreasFragment>unsafeCast(this));
    }
  }
