...
public class OverviewFragmentDirections {
  ...
  @NonNull
  public static ActionNavOverviewToNavDataentry actionNavOverviewToNavDataentry() {
    return new ActionNavOverviewToNavDataentry();
  }
  ...
  public static class ActionNavOverviewToNavDataentry implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionNavOverviewToNavDataentry() {
    }

    @NonNull
    public ActionNavOverviewToNavDataentry setMode(
    ...
    @NonNull
    public ActionNavOverviewToNavDataentry setMeasurementId(int measurementId) {
      this.arguments.put("measurementId", measurementId);
      return this;
    }

    @NonNull
    public ActionNavOverviewToNavDataentry setTitle(@NonNull String title) {
      if (title == null) {
    ...
    public int getActionId() {
      return R.id.action_nav_overview_to_nav_dataentry;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionNavOverviewToNavDataentry that = (ActionNavOverviewToNavDataentry) object;
    ...
    public String toString() {
      return "ActionNavOverviewToNavDataentry(actionId=" + getActionId() + "){"
          + "mode=" + getMode()
