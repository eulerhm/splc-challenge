...
public class GraphFragmentDirections {
  ...
  public static class ActionNavGraphToNavDataentry implements NavDirections {
    ...
    @NonNull
    public ActionNavGraphToNavDataentry setMode(
    ...
    @NonNull
    public ActionNavGraphToNavDataentry setMeasurementId(int measurementId) {
      this.arguments.put("measurementId", measurementId);
      return this;
    }

    @NonNull
    public ActionNavGraphToNavDataentry setTitle(@NonNull String title) {
      if (title == null) {
    ...
    public boolean equals(Object object) {
      ...
      ActionNavGraphToNavDataentry that = (ActionNavGraphToNavDataentry) object;
    ...
    public String toString() {
      return "ActionNavGraphToNavDataentry(actionId=" + getActionId() + "){"
          + "mode=" + getMode()
