...
public final class StatsModule_ProvideInsightsUseCaseFactory implements Factory<BaseListUseCase> {
  ...
  public StatsModule_ProvideInsightsUseCaseFactory(StatsModule module,
  ...
  public BaseListUseCase get() {
    return provideInsightsUseCase(module, statsStoreProvider.get(), bgDispatcherProvider.get(), mainDispatcherProvider.get(), statsSiteProvider.get(), useCasesProvider.get(), uiModelMapperProvider.get());
  }

  public static StatsModule_ProvideInsightsUseCaseFactory create(StatsModule module,
      Provider<StatsStore> statsStoreProvider, Provider<CoroutineDispatcher> bgDispatcherProvider,
      Provider<CoroutineDispatcher> mainDispatcherProvider,
      Provider<StatsSiteProvider> statsSiteProvider,
      Provider<List<BaseStatsUseCase<?, ?>>> useCasesProvider,
      Provider<UiModelMapper> uiModelMapperProvider) {
    return new StatsModule_ProvideInsightsUseCaseFactory(module, statsStoreProvider, bgDispatcherProvider, mainDispatcherProvider, statsSiteProvider, useCasesProvider, uiModelMapperProvider);
  }

  public static BaseListUseCase provideInsightsUseCase(StatsModule instance, StatsStore statsStore,
    ...
    return Preconditions.checkNotNullFromProvides(instance.provideInsightsUseCase(statsStore, bgDispatcher, mainDispatcher, statsSiteProvider, useCases, uiModelMapper));
  }
}
