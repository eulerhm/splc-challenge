...
public final class FollowerTypesUseCase_Factory implements Factory<FollowerTypesUseCase> {
  ...
  public FollowerTypesUseCase_Factory(Provider<CoroutineDispatcher> mainDispatcherProvider,
  ...
  @Override
  public FollowerTypesUseCase get() {
    return newInstance(mainDispatcherProvider.get(), bgDispatcherProvider.get(), followersStoreProvider.get(), publicizeStoreProvider.get(), statsSiteProvider.get(), contentDescriptionHelperProvider.get(), statsUtilsProvider.get(), resourceProvider.get());
  }

  public static FollowerTypesUseCase_Factory create(
      ...
      Provider<ContentDescriptionHelper> contentDescriptionHelperProvider,
      Provider<StatsUtils> statsUtilsProvider, Provider<ResourceProvider> resourceProvider) {
    return new FollowerTypesUseCase_Factory(mainDispatcherProvider, bgDispatcherProvider, followersStoreProvider, publicizeStoreProvider, statsSiteProvider, contentDescriptionHelperProvider, statsUtilsProvider, resourceProvider);
  }

  public static FollowerTypesUseCase newInstance(CoroutineDispatcher mainDispatcher,
    ...
    return new FollowerTypesUseCase(mainDispatcher, bgDispatcher, followersStore, publicizeStore, statsSiteProvider, contentDescriptionHelper, statsUtils, resourceProvider);
  }
}
