...
public abstract class Hilt_StatsNewFeaturesIntroDialogFragment extends FeatureIntroductionDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatsNewFeaturesIntroDialogFragment_GeneratedInjector) this.generatedComponent()).injectStatsNewFeaturesIntroDialogFragment(UnsafeCasts.<StatsNewFeaturesIntroDialogFragment>unsafeCast(this));
    }
  }
