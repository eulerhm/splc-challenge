...
public abstract class Hilt_SiteCreationSiteNameFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SiteCreationSiteNameFragment() {
    super();
  }

  Hilt_SiteCreationSiteNameFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SiteCreationSiteNameFragment_GeneratedInjector) this.generatedComponent()).injectSiteCreationSiteNameFragment(UnsafeCasts.<SiteCreationSiteNameFragment>unsafeCast(this));
    }
  }
