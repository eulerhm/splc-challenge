...
public abstract class Hilt_QRCodeAuthFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QRCodeAuthFragment() {
    super();
  }

  Hilt_QRCodeAuthFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QRCodeAuthFragment_GeneratedInjector) this.generatedComponent()).injectQRCodeAuthFragment(UnsafeCasts.<QRCodeAuthFragment>unsafeCast(this));
    }
  }
