...
public final class PostRecentWeeksUseCase_PostRecentWeeksUseCaseFactory_Factory implements Factory<PostRecentWeeksUseCase.PostRecentWeeksUseCaseFactory> {
  ...
  public PostRecentWeeksUseCase_PostRecentWeeksUseCaseFactory_Factory(
  ...
  @Override
  public PostRecentWeeksUseCase.PostRecentWeeksUseCaseFactory get() {
  ...
  public static PostRecentWeeksUseCase_PostRecentWeeksUseCaseFactory_Factory create(
      Provider<CoroutineDispatcher> mainDispatcherProvider,
      Provider<CoroutineDispatcher> backgroundDispatcherProvider,
      Provider<StatsSiteProvider> statsSiteProvider, Provider<StatsPostProvider> statsPostProvider,
      Provider<PostDetailMapper> postDetailMapperProvider,
      Provider<PostDetailStore> postDetailStoreProvider) {
    return new PostRecentWeeksUseCase_PostRecentWeeksUseCaseFactory_Factory(mainDispatcherProvider, backgroundDispatcherProvider, statsSiteProvider, statsPostProvider, postDetailMapperProvider, postDetailStoreProvider);
  }

  public static PostRecentWeeksUseCase.PostRecentWeeksUseCaseFactory newInstance(
    ...
    return new PostRecentWeeksUseCase.PostRecentWeeksUseCaseFactory(mainDispatcher, backgroundDispatcher, statsSiteProvider, statsPostProvider, postDetailMapper, postDetailStore);
  }
}
