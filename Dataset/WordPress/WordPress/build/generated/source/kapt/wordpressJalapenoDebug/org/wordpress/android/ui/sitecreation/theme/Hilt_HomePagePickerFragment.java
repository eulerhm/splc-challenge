...
public abstract class Hilt_HomePagePickerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomePagePickerFragment() {
    super();
  }

  Hilt_HomePagePickerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomePagePickerFragment_GeneratedInjector) this.generatedComponent()).injectHomePagePickerFragment(UnsafeCasts.<HomePagePickerFragment>unsafeCast(this));
    }
  }
