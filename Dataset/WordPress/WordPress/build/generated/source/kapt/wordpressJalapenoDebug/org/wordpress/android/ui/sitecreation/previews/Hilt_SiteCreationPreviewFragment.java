...
public abstract class Hilt_SiteCreationPreviewFragment extends SiteCreationBaseFormFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SiteCreationPreviewFragment_GeneratedInjector) this.generatedComponent()).injectSiteCreationPreviewFragment(UnsafeCasts.<SiteCreationPreviewFragment>unsafeCast(this));
    }
  }
