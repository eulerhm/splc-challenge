...
public final class AllTimeWidgetUpdater_Factory implements Factory<AllTimeWidgetUpdater> {
  ...
  public AllTimeWidgetUpdater_Factory(Provider<AppPrefsWrapper> appPrefsWrapperProvider,
  ...
  @Override
  public AllTimeWidgetUpdater get() {
  ...
  public static AllTimeWidgetUpdater_Factory create(
      ...
      Provider<ResourceProvider> resourceProvider, Provider<WidgetUtils> widgetUtilsProvider,
      Provider<AnalyticsTrackerWrapper> analyticsTrackerWrapperProvider) {
    return new AllTimeWidgetUpdater_Factory(appPrefsWrapperProvider, siteStoreProvider, accountStoreProvider, networkUtilsWrapperProvider, resourceProvider, widgetUtilsProvider, analyticsTrackerWrapperProvider);
  }

  public static AllTimeWidgetUpdater newInstance(AppPrefsWrapper appPrefsWrapper,
      SiteStore siteStore, AccountStore accountStore, NetworkUtilsWrapper networkUtilsWrapper,
      ResourceProvider resourceProvider, WidgetUtils widgetUtils,
      AnalyticsTrackerWrapper analyticsTrackerWrapper) {
    return new AllTimeWidgetUpdater(appPrefsWrapper, siteStore, accountStore, networkUtilsWrapper, resourceProvider, widgetUtils, analyticsTrackerWrapper);
  }
}
