...
public final class InsightsDetailListViewModel_Factory implements Factory<InsightsDetailListViewModel> {
  ...
  public InsightsDetailListViewModel_Factory(Provider<CoroutineDispatcher> mainDispatcherProvider,
  ...
  @Override
  public InsightsDetailListViewModel get() {
  ...
  public static InsightsDetailListViewModel_Factory create(
      Provider<CoroutineDispatcher> mainDispatcherProvider,
      Provider<BaseListUseCase> statsUseCaseProvider,
      Provider<AnalyticsTrackerWrapper> analyticsTrackerProvider,
      Provider<StatsDateSelector.Factory> dateSelectorFactoryProvider) {
    return new InsightsDetailListViewModel_Factory(mainDispatcherProvider, statsUseCaseProvider, analyticsTrackerProvider, dateSelectorFactoryProvider);
  }

  public static InsightsDetailListViewModel newInstance(CoroutineDispatcher mainDispatcher,
      BaseListUseCase statsUseCase, AnalyticsTrackerWrapper analyticsTracker,
      StatsDateSelector.Factory dateSelectorFactory) {
    return new InsightsDetailListViewModel(mainDispatcher, statsUseCase, analyticsTracker, dateSelectorFactory);
  }
}
