...
public abstract class Hilt_InsightsDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InsightsDetailFragment() {
    super();
  }

  Hilt_InsightsDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InsightsDetailFragment_GeneratedInjector) this.generatedComponent()).injectInsightsDetailFragment(UnsafeCasts.<InsightsDetailFragment>unsafeCast(this));
    }
  }
