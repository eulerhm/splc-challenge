...
public final class TotalCommentsUseCase_Factory implements Factory<TotalCommentsUseCase> {
  ...
  public TotalCommentsUseCase_Factory(Provider<CoroutineDispatcher> mainDispatcherProvider,
  ...
  @Override
  public TotalCommentsUseCase get() {
    return newInstance(mainDispatcherProvider.get(), bgDispatcherProvider.get(), visitsAndViewsStoreProvider.get(), statsSiteProvider.get(), resourceProvider.get(), statsDateFormatterProvider.get(), totalStatsMapperProvider.get(), analyticsTrackerProvider.get(), statsWidgetUpdatersProvider.get(), localeManagerWrapperProvider.get(), useCaseModeProvider.get());
  }

  public static TotalCommentsUseCase_Factory create(
      ...
      Provider<LocaleManagerWrapper> localeManagerWrapperProvider,
      Provider<BaseStatsUseCase.UseCaseMode> useCaseModeProvider) {
    return new TotalCommentsUseCase_Factory(mainDispatcherProvider, bgDispatcherProvider, visitsAndViewsStoreProvider, statsSiteProvider, resourceProvider, statsDateFormatterProvider, totalStatsMapperProvider, analyticsTrackerProvider, statsWidgetUpdatersProvider, localeManagerWrapperProvider, useCaseModeProvider);
  }

  public static TotalCommentsUseCase newInstance(CoroutineDispatcher mainDispatcher,
      ...
      LocaleManagerWrapper localeManagerWrapper, BaseStatsUseCase.UseCaseMode useCaseMode) {
    return new TotalCommentsUseCase(mainDispatcher, bgDispatcher, visitsAndViewsStore, statsSiteProvider, resourceProvider, statsDateFormatter, totalStatsMapper, analyticsTracker, statsWidgetUpdaters, localeManagerWrapper, useCaseMode);
  }
}
