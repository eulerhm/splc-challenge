...
public abstract class Hilt_SiteCreationIntentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SiteCreationIntentsFragment() {
    super();
  }

  Hilt_SiteCreationIntentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SiteCreationIntentsFragment_GeneratedInjector) this.generatedComponent()).injectSiteCreationIntentsFragment(UnsafeCasts.<SiteCreationIntentsFragment>unsafeCast(this));
    }
  }
