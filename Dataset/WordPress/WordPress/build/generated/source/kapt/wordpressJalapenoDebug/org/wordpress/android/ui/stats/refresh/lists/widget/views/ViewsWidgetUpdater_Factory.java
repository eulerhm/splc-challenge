...
public final class ViewsWidgetUpdater_Factory implements Factory<ViewsWidgetUpdater> {
  ...
  public ViewsWidgetUpdater_Factory(Provider<AppPrefsWrapper> appPrefsWrapperProvider,
  ...
  public static ViewsWidgetUpdater_Factory create(Provider<AppPrefsWrapper> appPrefsWrapperProvider,
      Provider<SiteStore> siteStoreProvider, Provider<AccountStore> accountStoreProvider,
      Provider<NetworkUtilsWrapper> networkUtilsWrapperProvider,
      Provider<ResourceProvider> resourceProvider, Provider<WidgetUtils> widgetUtilsProvider,
      Provider<AnalyticsTrackerWrapper> analyticsTrackerWrapperProvider) {
    return new ViewsWidgetUpdater_Factory(appPrefsWrapperProvider, siteStoreProvider, accountStoreProvider, networkUtilsWrapperProvider, resourceProvider, widgetUtilsProvider, analyticsTrackerWrapperProvider);
  }

  public static ViewsWidgetUpdater newInstance(AppPrefsWrapper appPrefsWrapper, SiteStore siteStore,
    ...
    return new ViewsWidgetUpdater(appPrefsWrapper, siteStore, accountStore, networkUtilsWrapper, resourceProvider, widgetUtils, analyticsTrackerWrapper);
  }
}
