...
public abstract class Hilt_SiteCreationDomainsFragment extends SiteCreationBaseFormFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SiteCreationDomainsFragment_GeneratedInjector) this.generatedComponent()).injectSiteCreationDomainsFragment(UnsafeCasts.<SiteCreationDomainsFragment>unsafeCast(this));
    }
  }
