...
public final class StatsWidgetMinifiedLightBinding implements ViewBinding {
  @NonNull
  ...
  private StatsWidgetMinifiedLightBinding(@NonNull LinearLayout rootView, @NonNull TextView name,
  ...
  @NonNull
  public static StatsWidgetMinifiedLightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StatsWidgetMinifiedLightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.stats_widget_minified_light, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StatsWidgetMinifiedLightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StatsWidgetMinifiedLightBinding((LinearLayout) rootView, name, value,
