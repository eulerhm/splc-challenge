...
public final class PostSignupInterstitialLandscapeBinding implements ViewBinding {
  @NonNull
  ...
  private PostSignupInterstitialLandscapeBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton addSelfHostedSiteButton, @NonNull MaterialButton createNewSiteButton,
      @NonNull MaterialButton dismissButton, @NonNull Guideline guideline,
      @NonNull ImageView illustrationView, @NonNull WPTextView subtitleView,
      @NonNull WPTextView titleView) {
  ...
  @NonNull
  public static PostSignupInterstitialLandscapeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PostSignupInterstitialLandscapeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.post_signup_interstitial_landscape, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PostSignupInterstitialLandscapeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PostSignupInterstitialLandscapeBinding((ConstraintLayout) rootView,
          addSelfHostedSiteButton, createNewSiteButton, dismissButton, guideline, illustrationView,
