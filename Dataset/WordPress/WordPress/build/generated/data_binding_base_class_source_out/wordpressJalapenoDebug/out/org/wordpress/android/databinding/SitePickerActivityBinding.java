...
public final class SitePickerActivityBinding implements ViewBinding {
  @NonNull
  ...
  private SitePickerActivityBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ActionableEmptyView actionableEmptyView, @NonNull AppBarLayout appbarMain,
      @NonNull CoordinatorLayout coordinatorLayout, @NonNull ProgressBar progress,
      @NonNull CustomSwipeRefreshLayout ptrLayout, @NonNull EmptyViewRecyclerView recyclerView,
  ...
  @NonNull
  public static SitePickerActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SitePickerActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.site_picker_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SitePickerActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SitePickerActivityBinding((CoordinatorLayout) rootView, actionableEmptyView,
          appbarMain, coordinatorLayout, progress, ptrLayout, recyclerView, toolbarMain);
    }
