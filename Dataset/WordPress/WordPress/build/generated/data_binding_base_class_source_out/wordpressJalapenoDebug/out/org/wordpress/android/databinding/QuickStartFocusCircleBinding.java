...
public final class QuickStartFocusCircleBinding implements ViewBinding {
  @NonNull
  ...
  private QuickStartFocusCircleBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static QuickStartFocusCircleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static QuickStartFocusCircleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.quick_start_focus_circle, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static QuickStartFocusCircleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new QuickStartFocusCircleBinding((RelativeLayout) rootView, quickStartFocusInnerCircle,
          quickStartFocusOuterCircle);
    }
