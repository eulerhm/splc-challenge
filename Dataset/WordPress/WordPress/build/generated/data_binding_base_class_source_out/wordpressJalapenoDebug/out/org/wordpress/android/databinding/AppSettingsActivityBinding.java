...
public final class AppSettingsActivityBinding implements ViewBinding {
  ...
  private AppSettingsActivityBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static AppSettingsActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AppSettingsActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.app_settings_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AppSettingsActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppSettingsActivityBinding((CoordinatorLayout) rootView, appbarMain,
