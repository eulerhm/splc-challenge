...
public final class CommentActivityBinding implements ViewBinding {
  ...
  private CommentActivityBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static CommentActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CommentActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.comment_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CommentActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CommentActivityBinding((CoordinatorLayout) rootView, appbarMain, coordinatorLayout,
          tabLayout, toolbarMain, viewPager);
    }
