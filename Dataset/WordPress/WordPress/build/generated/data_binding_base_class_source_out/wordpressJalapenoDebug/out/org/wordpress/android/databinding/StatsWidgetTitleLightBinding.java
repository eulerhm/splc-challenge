...
public final class StatsWidgetTitleLightBinding implements ViewBinding {
  @NonNull
  ...
  private StatsWidgetTitleLightBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static StatsWidgetTitleLightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StatsWidgetTitleLightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.stats_widget_title_light, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StatsWidgetTitleLightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StatsWidgetTitleLightBinding((LinearLayout) rootView, widgetSiteIcon, widgetTitle,
