...
public final class MyProfileActivityBinding implements ViewBinding {
  ...
  private MyProfileActivityBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static MyProfileActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MyProfileActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.my_profile_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MyProfileActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MyProfileActivityBinding((CoordinatorLayout) rootView, appbarMain,
