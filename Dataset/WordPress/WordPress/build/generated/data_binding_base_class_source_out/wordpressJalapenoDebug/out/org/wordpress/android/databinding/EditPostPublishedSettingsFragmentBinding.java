...
public final class EditPostPublishedSettingsFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private EditPostPublishedSettingsFragmentBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static EditPostPublishedSettingsFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EditPostPublishedSettingsFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.edit_post_published_settings_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EditPostPublishedSettingsFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EditPostPublishedSettingsFragmentBinding((LinearLayout) rootView,
