...
public final class CommentListFragmentBinding implements ViewBinding {
  ...
  private CommentListFragmentBinding(@NonNull RelativeLayout rootView,
      @NonNull ActionableEmptyView actionableEmptyView, @NonNull RecyclerView commentsRecyclerView,
      @NonNull ProgressBar progress, @NonNull CustomSwipeRefreshLayout ptrLayout) {
  ...
  @NonNull
  public static CommentListFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CommentListFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.comment_list_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CommentListFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CommentListFragmentBinding((RelativeLayout) rootView, actionableEmptyView,
          commentsRecyclerView, progress, ptrLayout);
    }
