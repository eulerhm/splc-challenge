...
public final class PostItemBinding implements ViewBinding {
  ...
  private PostItemBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialTextView excerpt,
      @NonNull ImageView featuredImage, @NonNull ImageView iconTime,
  ...
  public static PostItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.icon_time;
      ImageView iconTime = ViewBindings.findChildViewById(rootView, id);
      if (iconTime == null) {
        break missingId;
      }
      ...
      return new PostItemBinding((ConstraintLayout) rootView, excerpt, featuredImage, iconTime,
          title);
    }
