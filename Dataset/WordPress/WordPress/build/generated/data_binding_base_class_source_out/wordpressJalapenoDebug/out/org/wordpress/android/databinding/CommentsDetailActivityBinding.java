...
public final class CommentsDetailActivityBinding implements ViewBinding {
  @NonNull
  ...
  private CommentsDetailActivityBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appbarMain, @NonNull CoordinatorLayout coordinatorLayout,
      @NonNull ProgressBar progressLoading, @NonNull MaterialToolbar toolbarMain,
  ...
  @NonNull
  public static CommentsDetailActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CommentsDetailActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.comments_detail_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CommentsDetailActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CommentsDetailActivityBinding((CoordinatorLayout) rootView, appbarMain,
          coordinatorLayout, progressLoading, toolbarMain, viewpager);
    }
