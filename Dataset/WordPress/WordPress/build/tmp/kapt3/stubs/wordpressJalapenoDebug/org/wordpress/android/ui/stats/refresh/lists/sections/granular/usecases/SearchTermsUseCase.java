...
public final class SearchTermsUseCase extends org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularStatelessUseCase<org.wordpress.android.fluxc.model.stats.time.SearchTermsModel> {
    ...
    public SearchTermsUseCase(@org.jetbrains.annotations.NotNull()
    ...
    org.wordpress.android.fluxc.store.stats.time.SearchTermsStore store, @org.jetbrains.annotations.NotNull()
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.fluxc.model.stats.time.SearchTermsModel> continuation) {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.ui.stats.refresh.lists.sections.BaseStatsUseCase.State<org.wordpress.android.fluxc.model.stats.time.SearchTermsModel>> continuation) {
        return null;
    }
    ...
    org.wordpress.android.fluxc.model.stats.time.SearchTermsModel domainModel) {
        return null;
    }
    ...
    public static final class SearchTermsUseCaseFactory implements org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularUseCaseFactory {
        ...
        @javax.inject.Inject()
        public SearchTermsUseCaseFactory(@org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "UI_THREAD")
        kotlinx.coroutines.CoroutineDispatcher mainDispatcher, @org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "BG_THREAD")
        kotlinx.coroutines.CoroutineDispatcher backgroundDispatcher, @org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public org.wordpress.android.ui.stats.refresh.lists.sections.granular.usecases.SearchTermsUseCase build(@org.jetbrains.annotations.NotNull()
