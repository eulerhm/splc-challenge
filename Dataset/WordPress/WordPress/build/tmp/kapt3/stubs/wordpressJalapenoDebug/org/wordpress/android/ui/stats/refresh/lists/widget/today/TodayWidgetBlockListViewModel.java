...
public final class TodayWidgetBlockListViewModel implements org.wordpress.android.ui.stats.refresh.lists.widget.WidgetBlockListProvider.WidgetBlockListViewModel {
    ...
    @javax.inject.Inject()
    public TodayWidgetBlockListViewModel(@org.jetbrains.annotations.NotNull()
    ...
    private final java.util.List<org.wordpress.android.ui.stats.refresh.lists.widget.WidgetBlockListProvider.BlockItemUiModel> buildListItemUiModel(org.wordpress.android.fluxc.model.stats.VisitsModel domainModel, int localSiteId) {
        return null;
    }
}