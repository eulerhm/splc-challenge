...
public final class VideoPlaysUseCase extends org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularStatelessUseCase<org.wordpress.android.fluxc.model.stats.time.VideoPlaysModel> {
    ...
    public VideoPlaysUseCase(@org.jetbrains.annotations.NotNull()
    ...
    org.wordpress.android.fluxc.store.stats.time.VideoPlaysStore store, @org.jetbrains.annotations.NotNull()
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.fluxc.model.stats.time.VideoPlaysModel> continuation) {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.ui.stats.refresh.lists.sections.BaseStatsUseCase.State<org.wordpress.android.fluxc.model.stats.time.VideoPlaysModel>> continuation) {
        return null;
    }
    ...
    org.wordpress.android.fluxc.model.stats.time.VideoPlaysModel domainModel) {
        return null;
    }
    ...
    public static final class VideoPlaysUseCaseFactory implements org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularUseCaseFactory {
        ...
        @javax.inject.Inject()
        public VideoPlaysUseCaseFactory(@org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "UI_THREAD")
        kotlinx.coroutines.CoroutineDispatcher mainDispatcher, @org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "BG_THREAD")
        kotlinx.coroutines.CoroutineDispatcher backgroundDispatcher, @org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public org.wordpress.android.ui.stats.refresh.lists.sections.granular.usecases.VideoPlaysUseCase build(@org.jetbrains.annotations.NotNull()
