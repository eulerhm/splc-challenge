...
public final class FileDownloadsUseCase extends org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularStatelessUseCase<org.wordpress.android.fluxc.model.stats.time.FileDownloadsModel> {
    ...
    public FileDownloadsUseCase(@org.jetbrains.annotations.NotNull()
    ...
    org.wordpress.android.fluxc.store.stats.time.FileDownloadsStore store, @org.jetbrains.annotations.NotNull()
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.fluxc.model.stats.time.FileDownloadsModel> continuation) {
        return null;
    }
    ...
    kotlin.coroutines.Continuation<? super org.wordpress.android.ui.stats.refresh.lists.sections.BaseStatsUseCase.State<org.wordpress.android.fluxc.model.stats.time.FileDownloadsModel>> continuation) {
        return null;
    }
    ...
    org.wordpress.android.fluxc.model.stats.time.FileDownloadsModel domainModel) {
        return null;
    }
    ...
    public static final class FileDownloadsUseCaseFactory implements org.wordpress.android.ui.stats.refresh.lists.sections.granular.GranularUseCaseFactory {
        ...
        @javax.inject.Inject()
        public FileDownloadsUseCaseFactory(@org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "UI_THREAD")
        kotlinx.coroutines.CoroutineDispatcher mainDispatcher, @org.jetbrains.annotations.NotNull()
        @javax.inject.Named(value = "BG_THREAD")
        kotlinx.coroutines.CoroutineDispatcher backgroundDispatcher, @org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public org.wordpress.android.ui.stats.refresh.lists.sections.granular.usecases.FileDownloadsUseCase build(@org.jetbrains.annotations.NotNull()
